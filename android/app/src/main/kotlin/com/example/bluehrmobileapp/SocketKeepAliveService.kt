...
/**
 * Foreground Service that keeps the Flutter engine (and its socket connection)
...
class SocketKeepAliveService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "socket_keep_alive"
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Keeps connection alive during calls"
                setShowBadge(false)
                setSound(null, null)
            }
