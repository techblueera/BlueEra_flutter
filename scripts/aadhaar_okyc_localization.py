...
T = {
    "en": {
        ...
        "uploadAadhaarPhotoHint": "Upload clear photos of both the front and back of your Aadhaar card.",
    ...
    "hi": {
        ...
        "uploadAadhaarPhotoHint": "अपने आधार कार्ड के आगे और पीछे, दोनों हिस्सों की साफ़ फ़ोटो अपलोड करें।",
        "uploadAadhaarFront": "आधार का अगला हिस्सा अपलोड करें",
        "uploadAadhaarBack": "आधार का पिछला हिस्सा अपलोड करें",
    ...
    "gu": {
        ...
        "uploadAadhaarPhotoHint": "તમારા આધાર કાર્ડની આગળ અને પાછળ, બંને બાજુના સ્પષ્ટ ફોટા અપલોડ કરો.",
        "uploadAadhaarFront": "આધાર ફ્રન્ટ અપલોડ કરો",
        "uploadAadhaarBack": "આધાર બેક અપલોડ કરો",
    ...
    "mr": {
        ...
        "uploadAadhaarPhotoHint": "तुमच्या आधार कार्डाच्या पुढील आणि मागील, दोन्ही बाजूंचे स्पष्ट फोटो अपलोड करा.",
        "uploadAadhaarFront": "आधार पुढील बाजू अपलोड करा",
        "uploadAadhaarBack": "आधार मागील बाजू अपलोड करा",
    ...
    "kn": {
        ...
        "uploadAadhaarPhotoHint": "ನಿಮ್ಮ ಆಧಾರ್ ಕಾರ್ಡ್‌ನ ಮುಂಭಾಗ ಮತ್ತು ಹಿಂಭಾಗ, ಎರಡರ ಸ್ಪಷ್ಟ ಫೋಟೋಗಳನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.",
        "uploadAadhaarFront": "ಆಧಾರ್ ಮುಂಭಾಗ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ",
        "uploadAadhaarBack": "ಆಧಾರ್ ಹಿಂಭಾಗ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ",
