...
// Payment Setting;
  ...
  final String subscriptionPlansGet =
      'subscription-service/subscription/subscription-plans';
  ...
  final String hospitalHistoryBase =
      'hospital-service/history/$hospitalIDGlobal';
  ...
  final String userCurrentPlan =
      'subscription-service/subscription/user-subscriptions';
  ...
  ///Emergency
  final String getEmergencyProfile1 =
      'emergency-service/emergency-profile/$userId';
}
