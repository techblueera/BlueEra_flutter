...
ApplicationListingModel applicationListingModelFromJson(String str) =>
    ApplicationListingModel.fromJson(json.decode(str));

String applicationListingModelToJson(ApplicationListingModel data) =>
    json.encode(data.toJson());

class ApplicationListingModel {
  ApplicationListingModel({
    this.message,
    this.applications,
    this.jobDetails,
  });

  ApplicationListingModel.fromJson(dynamic json) {
...
Applications applicationsFromJson(String str) =>
    Applications.fromJson(json.decode(str));
...
class Applications {
  ...
  Applications.fromJson(dynamic json) {
    ...
    recruiterNotes = json['recruiterNotes'] != null
        ? json['recruiterNotes'].cast<String>()
        : [];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (answersToCustomQuestions != null) {
      map['answersToCustomQuestions'] =
          answersToCustomQuestions?.map((v) => v.toJson()).toList();
    }
...
AnswersToCustomQuestions answersToCustomQuestionsFromJson(String str) =>
    AnswersToCustomQuestions.fromJson(json.decode(str));

String answersToCustomQuestionsToJson(AnswersToCustomQuestions data) =>
    json.encode(data.toJson());
