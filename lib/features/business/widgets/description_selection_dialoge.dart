...
import 'package:get/get.dart';
 ...
 showDescriptionSuggestionsDialog({VoidCallback? onSaved}) {
  final businessDescriptionController =
      Get.find<BusinessDescriptionController>();
  final controller = Get.find<ViewBusinessDetailsController>();

  final tempSelected =
      businessDescriptionController.selectedDescription.value.obs;
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if ((tempSelected.value.isNotEmpty)) {
                        ...
                        controller.listingDescriptionController.value.text =
                            tempSelected.value;
                        controller.businessDescription.value= tempSelected.value;
