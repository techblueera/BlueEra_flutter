...
class BusinessQrCodeWidget extends StatefulWidget {
  ...
  /// Optional deep link to encode in the QR instead of the default
  /// `profileDeepLink`. Grocery stores pass `groceryProfileDeepLink` here so
  /// the QR opens the store directly (`/app/business/grocery/<id>`) rather
  /// than routing through the generic profile share-preview.
...
class _BusinessQrCodeWidgetState extends State<BusinessQrCodeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // final qrData = businessProfileDeepLink(
    //   userId: ownerUserId,
    // );
    final qrData = widget.deepLinkOverride ??
        profileDeepLink(
          userId: ownerUserId,
        );
...
class NewBusinessQrCodeWidget extends StatefulWidget {
  final BusinessProfileDetails? data;
  ...
  @override
  State<NewBusinessQrCodeWidget> createState() => _NewBusinessQrCodeWidgetState();
}

class _NewBusinessQrCodeWidgetState extends State<NewBusinessQrCodeWidget> {
  final GlobalKey _repaintKey = GlobalKey();
  final RxBool _isSaving = false.obs;
  final RxBool _isSharing = false.obs;
  ...
  Widget build(BuildContext context) {
    ...
    //   userId: ownerUserId,
    // );
    final qrData = schoolProfileDeepLink(
      userId: ownerUserId,
    );
