...
class _BusinessDetailsEditPageTwoState
    ...
    if (widget.prevBusinessDetails != null) {
      ...
      if ((viewBusinessDetailsController
          ...
          (viewBusinessDetailsController.selectedCategoryOfBusiness.value !=
              null)) {
        subCategorySpecializationTextController.text =
            data?.specification ?? '';
      } else {
  ...
  void _selectTime(BuildContext context, bool isOpenTime) {
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                onTap: () {
                  final selected = timeSlots[index];

                  if (isOpenTime) {
                    openTime = selected;
                  } else {
                    // Validate close time > open time
                    if (openTime != null && selected.compareTo(openTime!) <= 0) {
                      commonSnackBar(message: "Close time must be after open time");
                      return;
                    }
                    closeTime = selected;
                  }
              ...
              child: Column(
                ...
                children: [
                              ...
                              CommonTextField(
                                ...
                                onChange: (val) {
                                  ...
                                  if (!RegExp(r'^[a-zA-Z ]*$')
                                    ...
                                    viewBusinessDetailsController.errorMessage
                                        .value = "Mini 8 char required";
                                  } else if (newVal.length > 24) {
                                    viewBusinessDetailsController.errorMessage
                                        .value = "Maxi 24 char allowed";
                                  } else {
                                    viewBusinessDetailsController
                                        .errorMessage.value = "";
                                  }
                  ...
                  CommonTextField(
                    ...
                    inputLength: AppConstants.inputCharterLimit16,
                    keyBoardType: TextInputType.text,
                    regularExpression:
                        RegularExpressionUtils.alphabetSpacePattern,
                          ...
                          onTap: () async {
                            ...
                            if (viewBusinessDetailsController
                              ...
                              if (subCategoryTextController.text.isEmpty) {
                                commonSnackBar(
                                    message:
                                        "Please Enter Category of Business");
                                return;
                              }
                            }
                              ...
                              if (viewBusinessDetailsController
                                ...
                                ApiKeys.sub_category_Of_Business:
                                    viewBusinessDetailsController
                                        ...
                                        .value
                                        ?.sId,
                              if (subCategorySpecializationTextController
                                  .text.isNotEmpty)
  ...
  void validateForm() {
    ...
    validate = formValid && !hasEmptyField;
    setState(() {});
  }
}
