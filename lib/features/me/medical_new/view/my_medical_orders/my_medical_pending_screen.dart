...
class MyMedicalPendingScreen extends StatefulWidget {
  const MyMedicalPendingScreen({super.key});

  @override
  State<MyMedicalPendingScreen> createState() => _MyMedicalPendingScreenState();
}

class _MyMedicalPendingScreenState extends State<MyMedicalPendingScreen> {
