...
class MedicalBillDetailsSheet extends StatefulWidget {
  final String groceryOrderId;

   MedicalBillDetailsSheet({
  ...
  static void show(BuildContext context, {required String groceryOrderID}) {
    showModalBottomSheet(
      ...
      builder: (_) => MedicalBillDetailsSheet(
  ...
  @override
  State<MedicalBillDetailsSheet> createState() => _MedicalBillDetailsSheetState();
}

class _MedicalBillDetailsSheetState extends State<MedicalBillDetailsSheet> {
