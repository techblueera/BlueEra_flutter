...
import 'package:BlueEra/features/me/medical_new/model/chat_click_analytics_model.dart';
...
/// Statistics tab inside the medical screen.
///
...
class MedicalStatisticsScreen extends StatefulWidget {
  final String businessId;

  const MedicalStatisticsScreen({super.key, required this.businessId});

  @override
  State<MedicalStatisticsScreen> createState() =>
      _MedicalStatisticsScreenState();
}

class _MedicalStatisticsScreenState extends State<MedicalStatisticsScreen>
    with AutomaticKeepAliveClientMixin {
  late final MedicalStatisticsController _controller;
  ...
  void initState() {
    super.initState();
    _controller = getOrPut(() => MedicalStatisticsController());
