...
/// Rooms tab and the Overview tab so the two surfaces stay in sync.
class HotelChooseRoomCard extends StatelessWidget {
  final HotelDetailController controller;

  const HotelChooseRoomCard({super.key, required this.controller});
    ...
    return CommonCardWidget(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            final allRooms = controller.hotelData.value?.rooms ?? <Rooms>[];
          ...
          //           fontSize: 16,
          //         ),
          //         Icon(Icons.arrow_right_alt, color: AppColors.primaryColor),
          //       ],
          //     ),
          //   );
          // }),
