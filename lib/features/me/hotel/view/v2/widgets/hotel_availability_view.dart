...
const List<String> kHotelWeekDays = [
  'Monday',
  'Tuesday',
  'Wednesday',
  'Thursday',
...
/// Weekly-hours card for the hotel overview tab. Mirrors
/// [LabAvailabilityCard] visually — day rows with Open/Closed badge and time
/// chips, plus an edit pill in the header — and reads from the business-level
/// [ViewBusinessDetailsController.weeklySchedule] since hotels go live via
/// the shared business availability endpoint rather than a hotel-specific
/// model.
class HotelAvailabilityCard extends StatefulWidget {
  ...
  @override
  State<HotelAvailabilityCard> createState() => _HotelAvailabilityCardState();
}

class _HotelAvailabilityCardState extends State<HotelAvailabilityCard> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _openEditor() async {
    // Hotel-specific editor (mirrors the lab availability editor with hotel
    // copy). Persists through the shared business availability endpoint and
    // refreshes the schedule on success so the day rows update in place.
