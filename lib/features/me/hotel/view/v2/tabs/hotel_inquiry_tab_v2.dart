...
/// `LabInquiryTabV2`, `OtherInquiryTabV2` and the inquiry list used by
/// the Professionals Consultant "Order" tab
...
/// so the hotel owner sees who reached out to them.
///
...
class HotelInquiryTabV2 extends StatelessWidget {
  const HotelInquiryTabV2({super.key});
