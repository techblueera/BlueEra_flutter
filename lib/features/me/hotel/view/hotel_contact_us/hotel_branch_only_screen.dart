...
class HotelBranchOnlyScreen extends StatefulWidget {
  final SchoolContactUsData schoolContactUsData;

  const HotelBranchOnlyScreen({super.key, required this.schoolContactUsData});

  @override
  _HotelBranchOnlyScreenState createState() => _HotelBranchOnlyScreenState();
}

class _HotelBranchOnlyScreenState extends State<HotelBranchOnlyScreen> {
