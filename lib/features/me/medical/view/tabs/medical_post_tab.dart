...
/// **Post** tab of the medical merchant home: a "Create Post" action over the
/// merchant's own feed.
///
/// Content-only — the host wraps it in the shared scroll view, so [FeedScreen]
/// runs in `isInParentScroll` mode rather than owning a scroll.
class MedicalPostTab extends StatelessWidget {
  const MedicalPostTab({super.key});
