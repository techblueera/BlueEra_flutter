...
class MedicalListingScreen extends StatefulWidget {
  final List<MedicalNestedCategoryModel> arrLevel3Category;

  MedicalListingScreen(
      {super.key,
      required this.arrLevel3Category,
      });

  @override
  State<MedicalListingScreen> createState() => _MedicalListingScreenState();
}

class _MedicalListingScreenState extends State<MedicalListingScreen> {
  ...
  void _onScrollListener() {
    if (scrollController.position.pixels >=
        ...
        !controller.isUserMedicalLoadingMore.value &&
        controller.userMedicalHasMore) {
      controller.fetchUserGroceries(
        isLoadMore: true,
      );
    }
    ...
    return Obx(() => Scaffold(
          appBar: CommonBackAppBar(
              ...
              buildCustomActionWidget: () => Obx(()=> controller
                  .selectedMedicalProductVariants.isEmpty
                  ? Padding(
                ...
                child: Icon(Icons.search),
                  ...
                  : InkWell(
                onTap: () =>
                    Get.toNamed(RouteHelper.getMedicalCartScreenRoute()),
                child: Padding(
                  padding: const EdgeInsets.only(right: 20.0),
                  child: Stack(
                    ...
                    Positioned(
                        ...
                        child: Container(
                          ...
                          child: CustomText(
                            '${controller.selectedMedicalProductVariants.length}',
  ...
  Widget leftCategoryList() {
    return CommonGenericLeftSideCategoryList<MedicalNestedCategoryModel>(
      ...
      onTap: (item, index) {
        ...
        // If same category already selected â†’ DO NOTHING
                  ...
                  children: [
                    Expanded(
                        child: controller.isUserMedicalLoading.value
                            ...
                            : controller.arrUserMedicalProducts.isNotEmpty
                                ? Builder(
                                  builder: (context) {
                                    ...
                                    return GridView.builder(
                                        ...
                                        itemCount:
                                            controller.arrUserMedicalProducts.length +
                                                (controller.isUserMedicalLoadingMore
                                                        .value
                                                    ? 1
                                                    : 0),
                                        ...
                                        itemBuilder: (_, i) {
                                          ...
                                          return medicalCard(
                                              controller.arrUserMedicalProducts[i]);
                                        },
                                      );
                                  }
                                )
                ...
                child: Obx(() {
                  final bool isAdded =
                      groceryProductData.variants?.any((variant) =>
                          controller.selectedMedicalProductVariants
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          /// Add Button
          Obx(() {
            final bool isAdded = controller.selectedMedicalProductVariants
