...
/// `LabInquiryTabV2`: the shared [OrderActionsCarousel] sits on top, followed
/// by the incoming inquiries list.
///
...
/// [onAddServices], supplied by the host so it can drive the TabController.
///
...
class OtherInquiryTabV2 extends StatelessWidget {
  ...
  /// Switches the host screen's TabController to the Services tab.
