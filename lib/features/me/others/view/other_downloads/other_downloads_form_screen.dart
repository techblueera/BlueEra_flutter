...
import 'package:BlueEra/features/me/others/controller/other_downloads_controller.dart';
...
class OtherDownloadsFormScreen extends StatefulWidget {
  final OtherDownloadsData? item;

  const OtherDownloadsFormScreen({super.key, this.item});

  @override
  State<OtherDownloadsFormScreen> createState() =>
      _OtherDownloadsFormScreenState();
}
