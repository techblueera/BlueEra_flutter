...
/// Second half of the "other service" gallery upload: the photos are already
/// picked (see `OtherServicePhotosPhotoScreen._startUpload`), and this screen
/// is where they get a category.
///
...
/// lifted from the hotel gallery — a taxonomy that fits almost no "other
/// service" business, which is by definition one of the verticals the app
/// does NOT model. The gallery API stores a free `title` per group and there
/// is no server-side catalog of sections, so the options are the categories
/// this merchant has already created, plus an **Other** option that opens a
