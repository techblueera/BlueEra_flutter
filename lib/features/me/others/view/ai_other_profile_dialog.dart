...
class AiOtherProfileDialog extends StatefulWidget {
  AiOtherProfileDialog({super.key});

  @override
  State<AiOtherProfileDialog> createState() => _AiOtherProfileDialogState();
}

class _AiOtherProfileDialogState extends State<AiOtherProfileDialog> {
                ...
                children: [
                  Expanded(
                    ...
                    child: CustomBtn(
                      ...
                      onTap: isFormValid
                          ? controller.aiGenerateOtherServiceFetchDetailsController
                          : null,
                    ),
                  ),
