...
class OtherBranchOnlyScreen extends StatefulWidget {
  final SchoolContactUsData schoolContactUsData;

  const OtherBranchOnlyScreen({super.key, required this.schoolContactUsData});

  @override
  _OtherBranchOnlyScreenState createState() => _OtherBranchOnlyScreenState();
}
