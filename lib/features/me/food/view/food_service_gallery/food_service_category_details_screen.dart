...
class FoodServiceCategoryDetailsScreen extends StatelessWidget {
  final OtherServiceGalleryData categoryData;
  final FoodServicePhotoPhotoController controller = Get.find();

  FoodServiceCategoryDetailsScreen({required this.categoryData});
