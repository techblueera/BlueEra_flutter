...
/// Zomato-style swipe-to-reveal: the [child] slides left only up to a fixed
/// delete panel (it never fully dismisses); the user taps the revealed red
/// Delete button to act. Snaps open/closed on release.
