...
/// **Post** tab of the restaurant merchant home: a "Create Post" action over
/// the merchant's own feed.
///
...
class FoodPostTab extends StatelessWidget {
  const FoodPostTab({super.key});
