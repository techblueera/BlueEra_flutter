...
class _FoodSelfPickUpCartScreenState extends State<FoodSelfPickUpCartScreen> {
  ...
  double _checkoutTotal(FoodSelfPickupController controller,
  ...
  Future<void> _placeOrder(FoodSelfPickupController controller,
      Map<String, List<FoodVariants>> grouped) async {
