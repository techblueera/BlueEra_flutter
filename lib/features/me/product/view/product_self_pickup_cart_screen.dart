...
/// Place Order CTA.
class ProductSelfPickUpCartScreen extends StatefulWidget {
  const ProductSelfPickUpCartScreen({super.key});

  @override
  State<ProductSelfPickUpCartScreen> createState() =>
      _ProductSelfPickUpCartScreenState();
}

class _ProductSelfPickUpCartScreenState
    extends State<ProductSelfPickUpCartScreen> {
...
class _BottomBillSection extends StatelessWidget {
  final Map<String, List<GetProductData>> grouped;
  final ProductSelfPickupController controller;
  final double Function(List<GetProductData>, ProductSelfPickupController)
      calcTotal;
  final int Function(List<GetProductData>, ProductSelfPickupController)
      calcItemCount;
