...
/// into the controller's `selectedProducts` (one [SelectedVariant] per
/// ticked variant) — there is no separate "save" step — so the floating
/// cart on the parent screen reflects the selection live.
class ProductSelectionVariantSheet extends StatelessWidget {
  final Product product;
  final ProductController controller;

  const ProductSelectionVariantSheet({
    super.key,
  ...
  static Future<void> show({
    ...
    return Get.bottomSheet(
      ProductSelectionVariantSheet(product: product, controller: controller),
  ...
  void _toggle(Variant variant) {
    controller.toggleProductSelection(
      SelectedVariant(product: product, variant: variant),
    );
  }
