  ...
  Future<void> _confirmDeleteGalleryItem(VehicleGalleryItem g) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          AppStrings.removePhotoConfirm.tr,
        ),
        actions: [
          TextButton(
  ...
  Future<void> _confirmDeleteContact(VehicleContact c) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          AppStrings.removeNameCannotUndo.trParams({
  ...
  Future<void> _confirmDelete(Vehicle v) async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          AppStrings.removeNameCannotUndo.trParams({'N': v.name}),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
          ...
          children: [
            ...
            Obx(() {
              ...
              return IconButton(
                onPressed: onAdd,
                tooltip: empty
                    ? AppStrings.addContactTooltip.tr
                    : AppStrings.addAnotherTooltip.tr,
                icon: Icon(
                  empty
