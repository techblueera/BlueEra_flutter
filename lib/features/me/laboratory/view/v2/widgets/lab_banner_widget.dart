...
/// Laboratory cover-banner block — visually mirrors the medical/hospital
/// v2 banner widget. Tapping the empty state or the filled banner opens
/// the picture picker; the picked image is compressed and uploaded via
/// the existing lab cover upload endpoint.
class LabBannerWidget extends StatefulWidget {
  final LabFullDetailsController controller;

  const LabBannerWidget({super.key, required this.controller});

  @override
  State<LabBannerWidget> createState() => _LabBannerWidgetState();
}

class _LabBannerWidgetState extends State<LabBannerWidget> {
