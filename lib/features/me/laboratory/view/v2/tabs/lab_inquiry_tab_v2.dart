...
/// and the inquiry list used by the Professionals Consultant "Order" tab
...
/// so the laboratory owner sees who reached out to them.
///
...
class LabInquiryTabV2 extends StatelessWidget {
  const LabInquiryTabV2({super.key});
