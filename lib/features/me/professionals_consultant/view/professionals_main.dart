...
/// tabs card with a sticky overlay on scroll, and four tab bodies:
...
///   â€¢ Store    â€” earn-with-BlueEra cards
///   â€¢ Statics  â€” chat-click analytics
///
/// A Post tab used to sit between Store and Statics, embedding `FeedScreen`
/// on the user's own posts. It is gone — the Social section's "My Post" tab
/// owns that feed now. The posts COUNT on the stats card is unrelated and
/// stays: it comes from the followers/posts-count call, not from the feed.
...
class _ProfessionalsMainScreenState extends State<ProfessionalsMainScreen>
  ...
  // Overview MUST stay at index 1 — [BottomBarController.meOverviewTabIndex]
  // is a hard-coded 1 that deep links use to jump straight to it. Removing
  // Post (which sat after Store) kept that intact; anything added here must go
  // after Overview, not before it.
