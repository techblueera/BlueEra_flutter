...
class ManufacturerNestedCategoryWithInventoryScreen extends StatefulWidget {
  ...
  const ManufacturerNestedCategoryWithInventoryScreen({
    super.key,
  ...
  @override
  State<ManufacturerNestedCategoryWithInventoryScreen> createState() =>
      _ManufacturerNestedCategoryWithInventoryScreenState();
}

class _ManufacturerNestedCategoryWithInventoryScreenState
    extends State<ManufacturerNestedCategoryWithInventoryScreen> {
  final _inventoryController = getOrPut(() => ManufacturerInventoryController());
  ...
  void updateProductCategory(String incomingKey) {
    ...
    _inventoryController.productNestedCategoryList.value =
        matched?.children ?? [];
  }
                ...
                : MasonryGridView.count(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Get.toNamed(
                            RouteHelper.getMyManufacturerProductsScreenRoute(),
                            arguments: {
