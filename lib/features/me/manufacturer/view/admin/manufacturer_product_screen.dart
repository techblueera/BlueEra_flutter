...
class _ProductScreenState extends State<ManufacturerProductScreen>
  ...
  void initState() {
    ...
    // ManufacturerProductHomeScreen, which TabBarView doesn't build until the
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      showAddProductPromptIfNeeded(
        ...
        spec: const AddProductPromptSpec(
          titleKey: AppStrings.addPromptTitleManufacturer,
  ...
  Future<void> _onAddProduct() async {
    ...
    if (inventoryController.productDataNeedsRefresh) {
      ...
      // [ManufacturerInventoryController.markInventoryChanged], which dropped
      // the saved snapshot and started the refetch. The guarded call either
      // finds that work already done or does it once.
      inventoryController.fetchAllProductDataIfNeeded();
    }
  }
