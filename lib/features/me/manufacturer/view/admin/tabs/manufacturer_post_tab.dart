...
/// **Post** tab of the manufacturer merchant home — the merchant's own posts.
///
...
class ManufacturerPostTab extends StatelessWidget {
  const ManufacturerPostTab({super.key});
