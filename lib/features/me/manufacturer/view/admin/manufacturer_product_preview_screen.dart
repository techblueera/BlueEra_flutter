...
class ManufacturerProductPreviewArgs {
  ...
  final String? link;
  final List<ManufacturerDetailPair>? details;
  ...
  final List<ManufacturerProductListing>? listedProducts;

  /// for seeing listed products

  /// Both will be used for available options
  final List<ManufacturerSelectedColor>? selectedColors;
  ...
  ManufacturerProductPreviewArgs({
    this.productId,
    this.media,
    this.name,
    this.description,
...
class ManufacturerDetailPair {
  final String? title;
  final String? detail;
  const ManufacturerDetailPair(this.title, this.detail);
}

class ManufacturerProductPreviewScreen extends StatefulWidget {
  // final OwnProductData? productData;
  final String? id;
  final ProviderType? providerType;
  final ManufacturerProductPreviewArgs? productPreviewArgs;
  final bool isFromProductCreation;
  final bool isUserCanCreateVariants;

  const ManufacturerProductPreviewScreen(
      {super.key,
      required this.id,
...
class _ProductPreviewScreenState
  ...
  void loadPreviewArgs(ManufacturerProductPreviewArgs args) {
              ...
              children: [
                ...
                CustomFormCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomText(
                        'Here Is Your ManufacturerProduct details',
                        fontSize: SizeConfig.large,
                        fontWeight: FontWeight.w600,
                        color: AppColors.mainTextColor,
                      ),
