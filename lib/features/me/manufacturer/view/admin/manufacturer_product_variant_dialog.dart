...
/// from [ManufacturerInventoryController.isCreateNewProductVariantLoading].
class ManufacturerProductVariantDialog extends StatefulWidget {
  final String title;
  final Function(String, String, String, String) onSubmit;

  const ManufacturerProductVariantDialog({
    super.key,
    required this.title,
  ...
  @override
  State<ManufacturerProductVariantDialog> createState() => _ProductVariantDialogState();
}

class _ProductVariantDialogState extends State<ManufacturerProductVariantDialog> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final isLoading = Get.find<ManufacturerInventoryController>()
