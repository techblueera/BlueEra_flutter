...
class ManufacturerColorSelectionTile extends StatelessWidget {
  final ManufacturerProductController controller;
  final Function(Color, String) onSelectedColor;

  const ManufacturerColorSelectionTile(
      {Key? key, required this.controller, required this.onSelectedColor})
      : super(key: key);
