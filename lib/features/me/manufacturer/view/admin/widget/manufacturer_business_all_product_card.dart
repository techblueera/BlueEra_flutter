...
class ManufacturerBusinessAllProductCard extends StatefulWidget {
  final List<GetProductData> allProducts;

  const ManufacturerBusinessAllProductCard({
    super.key,
    required this.allProducts,
    });

  @override
  State<ManufacturerBusinessAllProductCard> createState() => _BusinessAllProductCardState();
}

class _BusinessAllProductCardState extends State<ManufacturerBusinessAllProductCard> {
  int _currentIndex = 0;
