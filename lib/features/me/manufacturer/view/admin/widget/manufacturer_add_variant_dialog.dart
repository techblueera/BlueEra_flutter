...
class ManufacturerAddVariantDialog extends StatefulWidget {
  ...
  const ManufacturerAddVariantDialog({super.key, required this.controller});

  @override
  State<ManufacturerAddVariantDialog> createState() =>
      _ManufacturerAddVariantDialogState();
}

class _ManufacturerAddVariantDialogState
    extends State<ManufacturerAddVariantDialog> {
  final titleController = TextEditingController();
  final detailController = TextEditingController();
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();

  // Local temp list for color selection
  final RxList<ManufacturerSelectedColor> localSelectedColors =
      <ManufacturerSelectedColor>[].obs;
      ...
      children: [
        ManufacturerColorSelectionTile(
          ...
          onSelectedColor: (color, colorName) {
            ManufacturerSelectedColor selectedColor =
      ...
      () => CustomBtn(
        ...
        onTap: () async {
          ...
          if (isColor) {
            ...
            final List<ManufacturerSelectedColor> mergedColors = [
