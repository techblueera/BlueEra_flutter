...
/// top-selling list on [ManufacturerVisitProductStoreDetailsScreen] and the grid on
/// the admin/customer `AllTopSellingProductsScreen` pages.
///
/// Tapping the section opens a [SimpleDialog] with the full details.
class ManufacturerProductTopSellingInfoSection extends StatelessWidget {
  final GetProductData product;

  const ManufacturerProductTopSellingInfoSection({
    super.key,
    required this.product,
  });
