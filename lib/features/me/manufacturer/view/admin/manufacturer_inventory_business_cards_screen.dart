...
class ManufacturerInventoryBusinessCardsScreen extends StatefulWidget {
  ...
  const ManufacturerInventoryBusinessCardsScreen({super.key, this.showBackAppBar = true});
...
class _InventoryBusinessCardsScreenState extends State<ManufacturerInventoryBusinessCardsScreen>
