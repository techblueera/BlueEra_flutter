...
class MyManufacturerProductsScreen extends StatefulWidget {
  final List<ProductCategoryWithInventoryModel> arrCategories;

  const MyManufacturerProductsScreen({
    super.key,
    required this.arrCategories,
  });

  @override
  State<MyManufacturerProductsScreen> createState() =>
      _MyProductProductsScreenState();
}

class _MyProductProductsScreenState extends State<MyManufacturerProductsScreen> {
