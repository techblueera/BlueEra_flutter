...
class ManufacturerAdminAllTopSellingProductsScreen extends StatefulWidget {
  const ManufacturerAdminAllTopSellingProductsScreen({super.key});

  @override
  State<ManufacturerAdminAllTopSellingProductsScreen> createState() =>
      _AdminAllTopSellingProductsScreenState();
}

class _AdminAllTopSellingProductsScreenState
    extends State<ManufacturerAdminAllTopSellingProductsScreen> {
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: AspectRatio(
                            aspectRatio: 1.05,
                            child:
                                ManufacturerProductTopSellingImage(product: items[index]),
                          ),
                        ),
                        ManufacturerProductTopSellingInfoSection(product: items[index]),
                      ],
                    ),
                  ),
                ),
