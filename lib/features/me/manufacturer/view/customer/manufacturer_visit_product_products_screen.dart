...
class ManufacturerVisitProductProductsScreen extends StatefulWidget {
  final ProductCategoryWithInventoryModel parentCategory;
  final String visitBusinessId;

  const ManufacturerVisitProductProductsScreen({
    super.key,
  ...
  @override
  State<ManufacturerVisitProductProductsScreen> createState() =>
...
class _ProductGridTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // visit_product_store_details_screen — same ManufacturerProductTopSellingImage
    // for the thumbnail + cart overlay, same ManufacturerProductTopSellingInfoSection
