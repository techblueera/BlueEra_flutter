...
import 'package:BlueEra/features/me/manufacturer/view/customer/manufacturer_store_product_card.dart';
...
class ManufacturerAllBusinessProductsScreen extends StatefulWidget {
  final String? productCategoryName;
  final String? productCategory;
  final bool isShowInGrid;

  const ManufacturerAllBusinessProductsScreen({
    super.key,
  ...
  @override
  State<ManufacturerAllBusinessProductsScreen> createState() => _AllBusinessProductsScreenState();
}

class _AllBusinessProductsScreenState extends State<ManufacturerAllBusinessProductsScreen> {
  ...
  Widget _buildProductContent() {
    return Obx(() {
      ...
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // ManufacturerProduct count chip
          // Padding(
          //   padding: EdgeInsets.only(
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: ManufacturerStoreProductCard(
