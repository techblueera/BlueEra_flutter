...
import 'package:BlueEra/features/me/manufacturer/view/customer/manufacturer_product_store_card.dart';
...
class ManufacturerProductsStoreScreen extends StatefulWidget {
  ...
  const ManufacturerProductsStoreScreen({
    super.key,
  ...
  @override
  State<ManufacturerProductsStoreScreen> createState() => _ProductsStoreScreenState();
}

class _ProductsStoreScreenState extends State<ManufacturerProductsStoreScreen> {
  final controller = getOrPut(() => StoreController());
  final AuthController _authController = Get.find<AuthController>();
  final RxInt _selectedIndex = 0.obs;

  final ManufacturerProductSelfPickupController productCartController =
  ...
  @override
  void dispose() {
    deleteIfRegistered<ManufacturerProductSelfPickupController>();
    super.dispose();
  }
  ...
  void _handleBackWithCartWarning() {
    ...
    _showCartWarningDialog(
      onPlaceOrder: () {
        Get.to(() => const ManufacturerProductSelfPickUpCartScreen());
      },
    );
  }
          ...
          body: Stack(
            children: [
              ...
              Positioned(
                ...
                bottom: 0,
                child: SafeArea(
                  child: ManufacturerProductSelfPickupCart(controller: productCartController),
                ),
              ),
            ],
          ),
