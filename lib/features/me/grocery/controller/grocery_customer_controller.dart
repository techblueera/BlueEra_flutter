...
import 'package:BlueEra/features/chat/view/orders_chat/order_chat_screen.dart';
...
class GroceryCustomerController extends GetxController {
  ...
  Rx<ApiResponse> userGroceryCategoryResponse =
      ApiResponse.initial('Initial').obs;
  Rx<ApiResponse> addGroceryOrderResponse = ApiResponse.initial('Initial').obs;
  ...
  String get currentTabKey => selectedTabIndex.value == 0
      ...
      : arrChildrenOfGroceryWithInventoryCategory[selectedTabIndex.value - 1]
              .key ??
          '';
  ...
  RxList<ChildrenOfGroceryCategoryResponse>
      arrChildrenOfGroceryWithInventoryCategory =
