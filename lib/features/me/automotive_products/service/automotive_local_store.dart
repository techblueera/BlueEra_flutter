...
class AutomotiveLocalStore {
  ...
  /// Catalogue-variant ids the shop already stocks — see
  /// [AutomotiveProductController.fetchStockedVariantIdsIfNeeded]. Per store,
  /// like the two above, because it answers a question about THIS store's
  /// inventory.
  ...
  /// Always `otherStore: false` — this is the SIGNED-IN shop's own inventory,
  /// the only store the add flow can publish into.
  static Future<AutomotiveCacheEntry?> readStockedVariantIds(String storeId) =>
