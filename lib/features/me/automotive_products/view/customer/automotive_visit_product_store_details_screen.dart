...
class AutomotiveVisitProductStoreDetailsScreen extends StatefulWidget {
  final String visitUserId;

  const AutomotiveVisitProductStoreDetailsScreen({
    super.key,
    required this.visitUserId,
  });

  @override
  State<AutomotiveVisitProductStoreDetailsScreen> createState() =>
      _AutomotiveVisitProductStoreDetailsScreenState();
}
      ...
      body: Stack(
        ...
        child: Column(
          children: [
            ...
            // ─── 2. Top Selling AutomotiveProducts (preview of 20) ───
            Obx(() {
