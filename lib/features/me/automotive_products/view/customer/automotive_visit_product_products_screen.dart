...
class AutomotiveVisitProductProductsScreen extends StatefulWidget {
  final AutomotiveProductCategoryWithInventoryModel parentCategory;
  final String visitBusinessId;

  const AutomotiveVisitProductProductsScreen({
    super.key,
  ...
  @override
  State<AutomotiveVisitProductProductsScreen> createState() =>
      _AutomotiveVisitProductProductsScreenState();
}
...
class _AutomotiveVisitProductProductsScreenState
  ...
  final Rxn<AutomotiveProductCategoryWithInventoryModel> _selectedCategory =
  ...
  Widget _buildSidebar() {
    ...
    return CommonGenericLeftSideCategoryList<AutomotiveProductCategoryWithInventoryModel>(
      items: level2,
...
class _AutomotiveProductGridTile extends StatelessWidget {
  ...
  const _AutomotiveProductGridTile({
  ...
  Widget build(BuildContext context) {
    ...
    // visit_product_store_details_screen — same AutomotiveProductTopSellingImage
