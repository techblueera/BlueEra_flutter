...
class AutomotiveStoreProductCard extends StatelessWidget {
  final ProductStore? productStore;
  final bool isShowInGrid;
  const AutomotiveStoreProductCard({Key? key, this.productStore, required this.isShowInGrid}) : super(key: key);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // AutomotivePrice Row — discount lives on the image now,
                    PriceRow(
                      sellingPrice:
