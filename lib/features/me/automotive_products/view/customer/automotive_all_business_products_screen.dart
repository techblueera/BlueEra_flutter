...
import 'package:BlueEra/features/me/automotive_products/view/customer/automotive_store_product_card.dart';
...
class AutomotiveAllBusinessProductsScreen extends StatefulWidget {
  final String? productCategoryName;
  final String? productCategory;
  final bool isShowInGrid;

  const AutomotiveAllBusinessProductsScreen({
    super.key,
  ...
  @override
  State<AutomotiveAllBusinessProductsScreen> createState() => _AutomotiveAllBusinessProductsScreenState();
}

class _AutomotiveAllBusinessProductsScreenState extends State<AutomotiveAllBusinessProductsScreen> {
    ...
    return Obx(() {
      ...
      return Column(
        ...
        children: [
          ...
          //         CustomText(
          //           "${productList.length}${controller.isProductDataLoadingMore.value ? '+' : ''} AutomotiveProducts",
          //           fontSize: 11,
          //           fontWeight: FontWeight.w600,
          //           color: AppColors.mainTextColor,
          //         ),
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: AutomotiveStoreProductCard(
