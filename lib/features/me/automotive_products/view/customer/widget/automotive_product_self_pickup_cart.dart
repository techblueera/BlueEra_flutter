...
class AutomotiveProductSelfPickupCart extends StatefulWidget {
  final AutomotiveProductSelfPickupController controller;

  const AutomotiveProductSelfPickupCart({
    super.key,
    required this.controller,
  });

  @override
  State<AutomotiveProductSelfPickupCart> createState() => _AutomotiveProductSelfPickupCartState();
}

class _AutomotiveProductSelfPickupCartState extends State<AutomotiveProductSelfPickupCart> {
  ...
  void _openCartScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const AutomotiveProductSelfPickUpCartScreen()),
    );
  }
  ...
  Widget _buildCollapsed(AutomotiveProductSelfPickupController c, Key key) {
  ...
  Widget _buildPanel(AutomotiveProductSelfPickupController c, Key key) {
  ...
  /// product photos.
  Widget _storeChip(AutomotiveProductSelfPickupController c, String bid) {
