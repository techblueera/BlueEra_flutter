...
class _AutomotiveProductCardPalette {
  ...
  const _AutomotiveProductCardPalette({
...
const _palettes = <_AutomotiveProductCardPalette>[
  _AutomotiveProductCardPalette(
...
class AutomotiveProductStoreCard extends StatelessWidget {
  ...
  const AutomotiveProductStoreCard({
    super.key,
    required this.ds,
    required this.index,
  ...
  _AutomotiveProductCardPalette get _palette =>
  ...
  Widget _buildBodyRow({
    ...
    required _AutomotiveProductCardPalette palette,
  }) {
    return Padding(
  ...
  Widget _buildAddressCard(BuildContext context, _AutomotiveProductCardPalette palette) {
    final store = _store;
  ...
  void _showPhotoDialog({
    ...
    showDialog<void>(
      ...
      builder: (_) => _AutomotiveProductPhotoDialog(
        images: images,
  ...
  void _openStore() {
    Get.to(() => AutomotiveVisitProductStoreDetailsScreen(
...
class _AutomotiveProductPhotoDialog extends StatefulWidget {
  final List<String> images;
  final int initialIndex;
  final String title;

  const _AutomotiveProductPhotoDialog({
  ...
  @override
  State<_AutomotiveProductPhotoDialog> createState() => _AutomotiveProductPhotoDialogState();
}

class _AutomotiveProductPhotoDialogState extends State<_AutomotiveProductPhotoDialog>
