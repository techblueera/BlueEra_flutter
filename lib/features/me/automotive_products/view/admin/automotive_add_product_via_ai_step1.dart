...
class AutomotiveAddProductViaAiStep1 extends StatefulWidget {
  ...
  AutomotiveAddProductViaAiStep1({super.key, required this.id, required this.providerType});

  @override
  State<AutomotiveAddProductViaAiStep1> createState() => _AutomotiveAddProductViaAiStep1State();
}

class _AutomotiveAddProductViaAiStep1State extends State<AutomotiveAddProductViaAiStep1> {
  final AutomotiveProductController controller = getOrPut(() => AutomotiveProductController());
  ...
  Widget _emptyImageDropTile() {
    return GestureDetector(
      ...
      child: CustomPaint(
        painter: _AutomotiveDashedBorderPainter(
  ...
  Widget _imageTile(AutomotiveProductController c, int index) {
    return CustomPaint(
      painter: _AutomotiveDashedBorderPainter(
        color: AppColors.primaryColor.withValues(alpha: 0.45),
        radius: 16,
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final AutomotiveProductNestedCategoryResponse item = currentDisplayList[index];
...
class _AutomotiveDashedBorderPainter extends CustomPainter {
  final Color color;
  final double radius;
  ...
  _AutomotiveDashedBorderPainter({
    required this.color,
    this.radius = 12,
  });
  ...
  @override
  bool shouldRepaint(covariant _AutomotiveDashedBorderPainter old) =>
