...
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_add_variant_dialog.dart';
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_color_selection_tile.dart';
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_skip_variant_dialog.dart';
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_submit_varient_dialog.dart';
...
class AutomotiveCreateVariantScreen extends StatefulWidget {
  final AutomotiveProductController controller;
  final String id;
  final ProviderType providerType;
  const AutomotiveCreateVariantScreen({super.key, required this.controller, required this.id, required this.providerType});

  @override
  State<AutomotiveCreateVariantScreen> createState() => _AutomotiveCreateVariantScreenState();
}

class _AutomotiveCreateVariantScreenState extends State<AutomotiveCreateVariantScreen> {
            ...
            CustomFormCard(
              child: Column(
                ...
                children: [
                  ...
                  // Add More AutomotiveVariant Button
                            ...
                            child: PositiveCustomBtn(
                              ...
                              onTap: () {
                                showDialog(
                                  ...
                                  builder: (context) => AutomotiveSkipVariantDialog(
                          ...
                          child: PositiveCustomBtn(
                            ...
                            onTap: widget.controller.isNextEnabled.value
                              ...
                              showDialog(
                                context: Get.context!,
                                barrierDismissible: false,
                                builder: (context) => AutomotiveSubmitVariantDialog(
                                  controller: widget.controller,
                                ),
                              );
                            }
              ...
              child: Wrap(
                ...
                children: widget.controller.selectedColors.map((color) {
                  ...
                  final isSelected = widget.controller.isValueSelected(
                    'color',
                    AutomotiveSelectedColor(color.color, color.name),
                  );
  ...
  Widget _buildAddMoreVariantButton() {
    return InkWell(
      onTap: () {
        showDialog(
          context: Get.context!,
          builder: (context) => AutomotiveAddVariantDialog(
            controller: widget.controller,
          ),
        );
      },
  ...
  void _openColorDialog(BuildContext context) {
    ...
    final newColors = <AutomotiveSelectedColor>[].obs; // Only new picks
                  ...
                  AutomotiveColorSelectionTile(
                    ...
                    onSelectedColor: (color, colorName) {
                      ...
                      if (!existingColors.any((c) => c.color == color) &&
                        ...
                        newColors.add(AutomotiveSelectedColor(color, colorName));
                      }
                    },
                  ),
  ...
  void _openColorComboDialog(
    ...
    final newColors = <AutomotiveSelectedColor>[].obs;
