...
class AutomotiveMyProductProductsScreen extends StatefulWidget {
  final List<AutomotiveProductCategoryWithInventoryModel> arrCategories;

  const AutomotiveMyProductProductsScreen({
    super.key,
    required this.arrCategories,
  });

  @override
  State<AutomotiveMyProductProductsScreen> createState() =>
      _AutomotiveMyProductProductsScreenState();
}

class _AutomotiveMyProductProductsScreenState extends State<AutomotiveMyProductProductsScreen> {
                ...
                : controller.productsByCategoryList.isNotEmpty
                    ? MasonryGridView.count(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return AutomotiveAdminProductCard(
                            product: product,
                            deleteProductApi: () {
