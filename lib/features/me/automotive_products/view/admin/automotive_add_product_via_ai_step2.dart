...
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_step1_section.dart';
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_step2_section.dart';
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_step3_section.dart';
...
class AutomotiveAddProductViaAiStep2 extends StatefulWidget {
  ...
  @override
  State<AutomotiveAddProductViaAiStep2> createState() => _AutomotiveAddProductViaAiStep2State();
}

class _AutomotiveAddProductViaAiStep2State extends State<AutomotiveAddProductViaAiStep2> {
  AutomotiveProductController controller = AutomotiveProductController();
        ...
        for (final colorItem in valueList) {
          ...
          if (colorItem is Map<String, dynamic>) {
            ...
            controller.selectedColors.add(
              AutomotiveSelectedColor(color, colorName),
            );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomBtn(
                          ...
                          onTap: () {
                            //Get.to(()=> AutomotiveProductPreviewScreen(controller: controller));
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    Get.to(() => AutomotiveStep1Section(controller: controller));
                  },
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    Get.to(() => AutomotiveStep2Section(controller: controller));
                  },
                  child: LocalAssets(imagePath: AppIconAssets.pen_line))
            ],
          ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    Get.to(() => AutomotiveStep3Section(controller: controller));
                  },
                  child: LocalAssets(imagePath: AppIconAssets.pen_line))
            ],
          ),
  ...
  Widget _variantCard(AutomotiveAiVariantData v) {
