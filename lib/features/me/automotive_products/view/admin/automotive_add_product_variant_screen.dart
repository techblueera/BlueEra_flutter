...
class AutomotiveAddProductVariantScreen extends StatefulWidget {
  const AutomotiveAddProductVariantScreen({super.key});

  @override
  State<AutomotiveAddProductVariantScreen> createState() =>
...
class _AutomotiveAddProductVariantScreenState extends State<AutomotiveAddProductVariantScreen> {
  ...
  /// validation pattern in [AutomotiveProductCartScreen] — a selling price > MRP
  /// is held in the field but never written into
  /// [AutomotiveInventoryController.variantSellingPrice], and blocks publish.
  ...
  List<AutomotiveSelectedVariant> get _allSelectedVariants {
  ...
  Map<String, List<AutomotiveSelectedVariant>> _groupedByProduct(
      List<AutomotiveSelectedVariant> list) {
    final grouped = <String, List<AutomotiveSelectedVariant>>{};
    for (final v in list) {
  ...
  double _effectiveSellingPrice(AutomotiveSelectedVariant v) {
  ...
  void _removeVariant(AutomotiveSelectedVariant row) {
    final id = row.id;
  ...
  String _variantLabel(AutomotiveVariant variant) {
  ...
  Widget _selectedProductCard(List<AutomotiveSelectedVariant> variants) {
  ...
  Widget _variantRow(String productId, AutomotiveSelectedVariant variantData) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // AutomotiveVariant identity chip + remove
          Row(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Flexible(
          ...
          // AutomotivePrice block — BOTH selling price and MRP, clearly labelled.
          Obx(() {
            final overridden =
  ...
  void _openEditSellingPriceDialog(AutomotiveSelectedVariant variantData) {
    final variant = variantData.variant;
