...
class AutomotiveProductCartScreen extends StatefulWidget {
  const AutomotiveProductCartScreen({super.key});

  @override
  State<AutomotiveProductCartScreen> createState() => _AutomotiveProductCartScreenState();
}

class _AutomotiveProductCartScreenState extends State<AutomotiveProductCartScreen> {
  ...
  Widget _buildCartCard(AutomotiveSelectedVariant variantData, int index) {
