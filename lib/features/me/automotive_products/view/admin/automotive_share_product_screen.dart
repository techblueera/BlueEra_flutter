...
class AutomotiveShareProductScreen extends StatefulWidget {
  ...
  const AutomotiveShareProductScreen({super.key, required this.productId});

  @override
  State<AutomotiveShareProductScreen> createState() => _AutomotiveShareProductScreenState();
}

class _AutomotiveShareProductScreenState extends State<AutomotiveShareProductScreen> {
  ...
  Widget ProductCard(){
    ...
    AutomotiveSingleProductData? singleProductData = controller.singleProductData.value;
    ...
    return GestureDetector(
      // onTap: (){
      //   AutomotiveProductPreviewArgs productPreviewArgs = mapProductDataToPreviewArgs(product);
      //   Get.toNamed(
      ...
      //     },
      //   );
      //   // AutomotiveProductPreviewArgs productPreviewArgs = mapOwnProductToPreviewArgs(product);
      //   // Get.toNamed(
      //   //   RouteHelper.getAutomotiveProductPreviewScreenRoute(),
      //   //   arguments: {
