...
class _AutomotivePartsScreenState extends State<AutomotivePartsScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      showAddProductPromptIfNeeded(
        ...
        // pushes the super-category screen and handles the post-publish jump
        // back to this tab itself.
  ...
  void _initializeData() {
    ...
    // longer surfaced here. Restore the label, the `AutomotivePostTab` view
        ...
        child: Stack(
          children: [
            HomeTabScaffold(
              ...
              tabViews: [
                _tabScroll(withBannerAdBelow(AutomotiveProductsTab(onAddProduct: _onAddProduct))),
