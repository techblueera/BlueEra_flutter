...
class _AutomotivePartsScreenState extends State<AutomotivePartsScreen>
  ...
  void _initializeData() {
    ...
    _tabViews = [
      _AutomotiveOrdersTabBody(),
      const AutomotiveProductHomeScreen(),
      _AutomotiveProductsTabBody(onAddProduct: _onAddProduct),
      _AutomotivePostTabBody(),
...
class _AutomotiveOrdersTabBody extends StatelessWidget {
  const _AutomotiveOrdersTabBody();
