...
class AutomotiveStep3Section extends StatefulWidget {
  ...
  const AutomotiveStep3Section({super.key, required this.controller});

  @override
  State<AutomotiveStep3Section> createState() => _AutomotiveStep3SectionState();
}

class _AutomotiveStep3SectionState extends State<AutomotiveStep3Section> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //   title: "AutomotiveProduct SKU Number (Optional)",
                  //   validator: controller.validateProductName,
                  //   showLabel: true,
                  // ),
                  // SizedBox(height: SizeConfig.size16),
                  ...
                  //   title: "AutomotiveProduct Id Number",
                  //   validator: controller.validateProductName,
                  //   showLabel: true,
                  // ),

                  // SizedBox(height: SizeConfig.size16),
                  // CustomText("AutomotiveCategory folder"),
                  // SizedBox(height: SizeConfig.size16),
                  // Container(
                  ...
                  //   child: CustomText(
                  //     "Choose AutomotiveCategory Folder",
                  ...
                  // /// Selling AutomotivePrice
                  // CommonTextField(
                  //   textEditController: controller.sellingPriceController,
                  //   title: 'Selling AutomotivePrice (RS.)',
                  //   hintText: 'E.g. ₹500',
                  ...
                  /// Warranty
                  // CommonTextField(
                  //   title: "AutomotiveProduct Warranty",
                  //   hintText: "Eg. 1 Years",
