...
class AutomotiveSkipVariantDialog extends StatefulWidget {
  final AutomotiveProductController controller;
  const AutomotiveSkipVariantDialog({super.key, required this.controller});

  @override
  State<AutomotiveSkipVariantDialog> createState() => _AutomotiveSkipVariantDialogState();
}

class _AutomotiveSkipVariantDialogState extends State<AutomotiveSkipVariantDialog> {
