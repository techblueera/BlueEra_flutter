...
class AutomotiveSubmitVariantDialog extends StatefulWidget {
  final AutomotiveProductController controller;

  const AutomotiveSubmitVariantDialog({
    super.key,
    required this.controller,
  });

  @override
  State<AutomotiveSubmitVariantDialog> createState() => _AutomotiveSubmitVariantDialogState();
}

class _AutomotiveSubmitVariantDialogState extends State<AutomotiveSubmitVariantDialog> {
                  ...
                  onTap: () {
                    if (formKey.currentState!.validate()) {
                      widget.controller.addProductsInListing(
                          productListing: AutomotiveProductListing(
                              id: "",
