...
class AutomotiveAddVariantDialog extends StatefulWidget {
  ...
  const AutomotiveAddVariantDialog({super.key, required this.controller});

  @override
  State<AutomotiveAddVariantDialog> createState() => _AutomotiveAddVariantDialogState();
}

class _AutomotiveAddVariantDialogState extends State<AutomotiveAddVariantDialog> {
  final titleController = TextEditingController();
  final detailController = TextEditingController();
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();

  // Local temp list for color selection
  final RxList<AutomotiveSelectedColor> localSelectedColors = <AutomotiveSelectedColor>[].obs;
      ...
      children: [
        AutomotiveColorSelectionTile(
          ...
          onSelectedColor: (color, colorName) {
            AutomotiveSelectedColor selectedColor = AutomotiveSelectedColor(color, colorName);
            if (!localSelectedColors.contains(selectedColor)) {
              localSelectedColors.add(selectedColor);
            }
            return AutomotiveSelectedColor(color, colorName);
          },
        ),
      ...
      () => CustomBtn(
        ...
        onTap: () async {
          ...
          if (isColor) {
            ...
            final List<AutomotiveSelectedColor> mergedColors = [
