...
import 'package:BlueEra/features/me/automotive_products/view/admin/widget/automotive_add_more_details_dialog.dart';
...
class AutomotiveStep2Section extends StatefulWidget {
  final AutomotiveProductController controller;
  const AutomotiveStep2Section({super.key, required this.controller});

  @override
  State<AutomotiveStep2Section> createState() => _AutomotiveStep2SectionState();
}

class _AutomotiveStep2SectionState extends State<AutomotiveStep2Section> {
  late List<TextEditingController> tempFeatureControllers;
  late TextEditingController tempLinkController;
  late List<AutomotiveProductMoreDetails> tempDetailsList;
  ...
  void initState() {
    ...
    tempDetailsList = List<AutomotiveProductMoreDetails>.from(widget.controller.detailsList);
  }
  ...
  void _restoreOldValues() {
    ...
    // tempDetailsList is List<AutomotiveSpecification>
  ...
  Widget _buildProductFeaturesSection(
      AutomotiveProductController controller) {
    // min- 20
  ...
  Future<void> showAddMoreDetailsDialog(BuildContext context) async {
   ...
   showDialog(
      ...
      builder: (_) => const AutomotiveAddMoreDetailsDialog(
