...
// import 'package:BlueEra/features/me/automotive_products/widget/automotive_color_selection_tile.dart';
...
//
// class AutomotiveStep4Section extends StatefulWidget {
//   final AddProductViaAiController controller;
//   AutomotiveStep4Section({Key? key, required this.controller}) : super(key: key);
//
//   @override
//   State<AutomotiveStep4Section> createState() => _AutomotiveStep4SectionState();
// }
//
// class _AutomotiveStep4SectionState extends State<AutomotiveStep4Section> {
//   late final AddProductViaAiController controller;
//
//   // Store original values for restoration
//   late List<AutomotiveSelectedColor> originalColors;
...
//     originalColors = List<AutomotiveSelectedColor>.from(
...
//         originalColors.map((color) => AutomotiveSelectedColor(color.color, color.name))
//     );
//
...
//           title: 'AutomotiveProduct AutomotiveVariant',
//           onBackTap: () async {
//             final shouldPop = await _handleBackPress(context);
//             if (shouldPop) {
//               Navigator.of(context).pop();
