...
class AutomotiveStep1Section extends StatefulWidget {
  final AutomotiveProductController controller;

  const AutomotiveStep1Section({super.key, required this.controller});

  @override
  State<AutomotiveStep1Section> createState() => _AutomotiveStep1SectionState();
}

class _AutomotiveStep1SectionState extends State<AutomotiveStep1Section> {
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      //         label: i == 0 ? 'AutomotiveCategory' : 'Subcategory $i',
  ...
  Widget _buildTagsSection(AutomotiveProductController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        CustomText(
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              GetBuilder<AutomotiveProductController>(
                id: "addIcon",
                builder: (_) {
