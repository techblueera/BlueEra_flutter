...
class AutomotiveColorSelectionTile extends StatelessWidget {
  final AutomotiveProductController controller;
  final Function(Color, String) onSelectedColor;

  const AutomotiveColorSelectionTile({Key? key, required this.controller, required this.onSelectedColor}) : super(key: key);
