...
Future<void> showCategoryBottomSheet(BuildContext context) async {
  final controller = Get.find<AutomotiveProductController>();
  ...
  await showModalBottomSheet<List<AutomotiveCategoryData>>(
    context: context,
...
Widget _buildSearchResults(AutomotiveProductController controller, BuildContext context) {
