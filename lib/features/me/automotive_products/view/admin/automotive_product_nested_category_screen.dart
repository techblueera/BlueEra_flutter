...
class AutomotiveProductNestedCategoryScreen extends StatefulWidget {
  ...
  final List<AutomotiveProductNestedCategoryResponse> children;

  const AutomotiveProductNestedCategoryScreen({
    super.key,
  ...
  @override
  State<AutomotiveProductNestedCategoryScreen> createState() =>
      _AutomotiveProductNestedCategoryScreenState();
}

class _AutomotiveProductNestedCategoryScreenState
    extends State<AutomotiveProductNestedCategoryScreen> {
  final controller = getOrPut(() => AutomotiveProductController());

  late String _argArrProductCatName;
  late String _argArrProductCatId;
  late List<AutomotiveProductNestedCategoryResponse> _argArrProductSuperCat;
  List<AutomotiveProductNestedCategoryResponse> _filteredChildren = [];
  ...
  Future<void> _onSuperCategorySelected(
      AutomotiveProductNestedCategoryResponse value) async {
    setState(() {
            ...
            : MasonryGridView.count(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      Get.toNamed(
                        RouteHelper.getAutomotiveStoreProductSelectionScreenRoute(),
                        arguments: {
