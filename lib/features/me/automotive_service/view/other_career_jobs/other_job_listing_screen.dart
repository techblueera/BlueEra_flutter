...
class OtherJobListingScreen extends StatefulWidget {
  const OtherJobListingScreen({super.key});

  @override
  State<OtherJobListingScreen> createState() => _OtherJobListingScreenState();
}

class _OtherJobListingScreenState extends State<OtherJobListingScreen> {
  @override
