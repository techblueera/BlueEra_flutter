...
import 'package:BlueEra/features/me/automotive_service/controller/automotive_privacy_condition_controller.dart';
...
class AutomotivePrivacyConditionFormScreen extends StatefulWidget {
  final OtherTNCData? item;

  const AutomotivePrivacyConditionFormScreen({super.key, this.item});

  @override
  State<AutomotivePrivacyConditionFormScreen> createState() =>
      _AutomotivePrivacyConditionFormScreenState();
}

class _AutomotivePrivacyConditionFormScreenState
    extends State<AutomotivePrivacyConditionFormScreen> {
