...
import 'package:BlueEra/features/me/automotive_service/view/other_privacy_condition/automotive_privacy_condition_form_screen.dart';
            ...
            SafeArea(
              child: Padding(
                ...
                child: AddMoreIconButton(onTapEvent: () {
                  Get.to(() => AutomotivePrivacyConditionFormScreen());
                }),
              ),
            ),
          ],
              ...
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () => Get.to(() => AutomotivePrivacyConditionFormScreen(
                      item: item,
                    )),
                  ),
                  IconButton(
