...
class AutomotiveHeaderView extends StatefulWidget {
  final AutomotiveBusinessProfileFullController schoolAboutUsController;

  const AutomotiveHeaderView({
    super.key,
    required this.schoolAboutUsController,
  });

  @override
  State<AutomotiveHeaderView> createState() => _AutomotiveHeaderViewState();
}

class _AutomotiveHeaderViewState extends State<AutomotiveHeaderView> {
  File? _bannerImage;
  File? _logoImage;
