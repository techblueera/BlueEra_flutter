...
import 'package:BlueEra/features/me/automotive_service/view/v2/tabs/automotive_overview_tab_v2.dart';
// import 'package:BlueEra/features/me/automotive_service/view/v2/tabs/automotive_posts_tab_v2.dart';
import 'package:BlueEra/features/me/automotive_service/view/v2/tabs/automotive_services_tab_v2.dart';
import 'package:BlueEra/features/me/automotive_service/view/v2/tabs/automotive_stats_tab_v2.dart';
...
/// `AutomotiveHomeScreenV2` (under `me/others/`). Uses the shared [HomeTabScaffold]
...
class AutomotiveHomeScreenV2 extends StatefulWidget {
  const AutomotiveHomeScreenV2({super.key});

  @override
  State<AutomotiveHomeScreenV2> createState() => _AutomotiveHomeScreenV2State();
}

class _AutomotiveHomeScreenV2State extends State<AutomotiveHomeScreenV2>
  ...
  List<String> get _tabs => [
        ...
        // with the `AutomotivePostsTabV2` view below.
        // AppStrings.posts.tr,
          ...
          children: [
            HomeTabScaffold(
              ...
              tabViews: [
                ...
                _tabScroll(AutomotiveOverviewTabV2(controller: _otherController)),
                // _tabScroll(const AutomotivePostsTabV2()),
                _tabScroll(const AutomotiveStatsTabV2()),
              ],
            ),
          ],
        ),
