...
/// user with the same Create-Post dialog (Lekha / Symbol / Poll / Job).
class AutomotivePostsTabV2 extends StatelessWidget {
  const AutomotivePostsTabV2({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        FeedScreen(
          key: const ValueKey('other_v2_my_posts'),
