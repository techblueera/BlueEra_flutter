...
class AutomotiveBannerWidget extends StatefulWidget {
  final AutomotiveBusinessProfileFullController controller;

  const AutomotiveBannerWidget({super.key, required this.controller});

  @override
  State<AutomotiveBannerWidget> createState() => _AutomotiveBannerWidgetState();
}

class _AutomotiveBannerWidgetState extends State<AutomotiveBannerWidget> {
