...
import 'package:BlueEra/features/me/automotive_service/view/other_news/automotive_news_form_screen.dart';
...
class AutomotiveNewsScreen extends StatelessWidget {
  AutomotiveNewsScreen({super.key});
            ...
            SafeArea(
              child: Padding(
                ...
                child: AddMoreIconButton(onTapEvent: () {
                  Get.to(() => AutomotiveNewsFormScreen());
                }),
              ),
            ),
          ],
              ...
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () => Get.to(() => AutomotiveNewsFormScreen(
                      item: item,
                    )),
                  ),
                  IconButton(
