...
import 'package:BlueEra/features/me/automotive_service/controller/automotive_news_controller.dart';
...
class AutomotiveNewsFormScreen extends StatefulWidget {
  final OtherNewsData? item;

  const AutomotiveNewsFormScreen({super.key, this.item});

  @override
  State<AutomotiveNewsFormScreen> createState() =>
      _AutomotiveNewsFormScreenState();
}

class _AutomotiveNewsFormScreenState
    extends State<AutomotiveNewsFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonBackAppBar(
        title: widget.item == null ? AppStrings.otherAddNews.tr : AppStrings.otherEditNews.tr,
      ),
            ...
            children: [
              ...
              Obx(() {
                return AiDescriptionField(
                  label: AppStrings.otherNewsFieldLabel.tr,
                  hintText: AppStrings.otherTellAboutNews.tr,
