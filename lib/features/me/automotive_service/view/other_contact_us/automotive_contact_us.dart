...
import 'package:BlueEra/features/me/automotive_service/view/other_contact_us/automotive_department_only_screen.dart';
...
class AutomotiveContactUs extends StatefulWidget {
  const AutomotiveContactUs({super.key,});
  @override
  State<AutomotiveContactUs> createState() => _AutomotiveContactUsState();
}

class _AutomotiveContactUsState extends State<AutomotiveContactUs> {
      ...
      body: SafeArea(
        child: Column(
          children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    Get.to(() => AutomotiveBranchOnlyScreen(schoolContactUsData: data,));
                                  },
                                  child: LocalAssets(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () {
                                              Get.to(() => AutomotiveDepartmentOnlyScreen(
            ...
            AddMoreIconButton(
              onTapEvent: () {
                Get.to(() => AutomotiveBranchDetailsFormScreen());
              },
