...
class AutomotiveBranchOnlyScreen extends StatefulWidget {
  ...
  const AutomotiveBranchOnlyScreen({super.key, required this.schoolContactUsData});

  @override
  _AutomotiveBranchOnlyScreenState createState() => _AutomotiveBranchOnlyScreenState();
}

class _AutomotiveBranchOnlyScreenState extends State<AutomotiveBranchOnlyScreen> {
