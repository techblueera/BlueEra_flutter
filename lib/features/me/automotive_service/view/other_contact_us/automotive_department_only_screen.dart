...
class AutomotiveDepartmentOnlyScreen extends StatefulWidget {
  final OtherProfileDepartments? contactInfo;
  final bool? isContactInfoEdit;
  final String? branchId;

  const AutomotiveDepartmentOnlyScreen(
      {super.key, this.isContactInfoEdit, this.contactInfo, this.branchId});

  @override
  _AutomotiveDepartmentOnlyScreenState createState() =>
      _AutomotiveDepartmentOnlyScreenState();
}

class _AutomotiveDepartmentOnlyScreenState extends State<AutomotiveDepartmentOnlyScreen> {
