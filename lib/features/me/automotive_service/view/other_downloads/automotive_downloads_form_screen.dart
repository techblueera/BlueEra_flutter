...
import 'package:BlueEra/features/me/automotive_service/controller/automotive_downloads_controller.dart';
...
class AutomotiveDownloadsFormScreen extends StatefulWidget {
  final OtherDownloadsData? item;

  const AutomotiveDownloadsFormScreen({super.key, this.item});

  @override
  State<AutomotiveDownloadsFormScreen> createState() =>
      _AutomotiveDownloadsFormScreenState();
}

class _AutomotiveDownloadsFormScreenState
    extends State<AutomotiveDownloadsFormScreen> {
  ...
  void initState() {
    ...
    if (widget.item != null) {
      controller.setFormData(widget.item ?? OtherDownloadsData());
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonBackAppBar(
        title: widget.item == null ? AppStrings.otherAddDownloads.tr : AppStrings.otherEditDownloads.tr,
      ),
            ...
            children: [
              ...
              Obx(() {
                return AiDescriptionField(
                  label: AppStrings.downloads.tr,
                  hintText: AppStrings.otherTellAboutDownloads.tr,
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (widget.item == null) {
                      ...
                      controller.updateDownloadsController(widget.item?.sId ?? "",
