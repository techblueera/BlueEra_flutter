...
import 'package:BlueEra/features/me/automotive_service/view/other_downloads/automotive_downloads_form_screen.dart';
...
class AutomotiveDownloadsScreen extends StatelessWidget {
  AutomotiveDownloadsScreen({super.key});
            ...
            SafeArea(
              child: Padding(
                ...
                child: AddMoreIconButton(onTapEvent: () {
                  Get.to(() => AutomotiveDownloadsFormScreen());
                }),
              ),
            ),
          ],
              ...
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () => Get.to(() => AutomotiveDownloadsFormScreen(
                      item: item,
                    )),
                  ),
                  IconButton(
