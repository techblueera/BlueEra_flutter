...
import 'package:BlueEra/features/me/automotive_service/view/other_service_gallery/automotive_service_category_details_screen.dart';
import 'package:BlueEra/features/me/automotive_service/view/other_service_gallery/automotive_upload_service_photos_screen.dart';
...
class AutomotiveServicePhotosPhotoScreen extends StatelessWidget {
      ...
      body: Obx(() {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
              onTap: () {
                Get.to(() => AutomotiveServiceCategoryDetailsScreen(
                  categoryData: item,
                ));
              },
              child: Card(
  ...
  Future<void> _startUpload(BuildContext context) async {
    ...
    Get.to(() => const AutomotiveUploadOtherServicePhotosScreen());
  }
