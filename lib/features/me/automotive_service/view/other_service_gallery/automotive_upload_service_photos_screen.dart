...
/// already picked (see `AutomotiveServicePhotosPhotoScreen._startUpload`), and this
...
class AutomotiveUploadOtherServicePhotosScreen extends StatefulWidget {
  const AutomotiveUploadOtherServicePhotosScreen({super.key});

  @override
  State<AutomotiveUploadOtherServicePhotosScreen> createState() =>
      _AutomotiveUploadOtherServicePhotosScreenState();
}

class _AutomotiveUploadOtherServicePhotosScreenState
    extends State<AutomotiveUploadOtherServicePhotosScreen> {
