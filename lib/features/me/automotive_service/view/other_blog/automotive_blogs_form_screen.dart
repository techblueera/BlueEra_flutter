...
class AutomotiveBlogsFormScreen extends StatefulWidget {
  final OtherBlogsData? item;

  const AutomotiveBlogsFormScreen({super.key, this.item});

  @override
  State<AutomotiveBlogsFormScreen> createState() => _AutomotiveBlogsFormScreenState();
}

class _AutomotiveBlogsFormScreenState extends State<AutomotiveBlogsFormScreen> {
