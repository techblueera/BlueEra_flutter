...
import 'package:BlueEra/features/me/automotive_service/controller/automotive_blogs_controller.dart';
import 'package:BlueEra/features/me/others/model/other_blogs_model.dart';
import 'package:BlueEra/features/me/automotive_service/view/other_blog/automotive_blogs_form_screen.dart';
...
class AutomotiveBlogsScreen extends StatelessWidget {
  AutomotiveBlogsScreen({super.key});
            ...
            SafeArea(
              child: Padding(
                ...
                child: AddMoreIconButton(onTapEvent: () {
                  Get.to(() => AutomotiveBlogsFormScreen());
                }),
              ),
            ),
          ],
  ...
  Widget _buildItemCard(BuildContext context, OtherBlogsData item) {
    return Container(
              ...
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () => Get.to(() => AutomotiveBlogsFormScreen(
                      item: item,
                    )),
                  ),
                  IconButton(
