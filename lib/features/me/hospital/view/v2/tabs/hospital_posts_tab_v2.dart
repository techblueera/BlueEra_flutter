...
/// Posts tab — embeds the global FeedScreen filtered to the current user
/// and exposes a "Create Post" CTA mirroring the global app-bar entries.
class HospitalPostsTabV2 extends StatelessWidget {
  const HospitalPostsTabV2({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        FeedScreen(
          key: const ValueKey('hospital_v2_my_posts'),
