...
class JobSeekerAddPublishingFormScreen extends StatefulWidget {
  final Map<String, dynamic>? publicationData; // For edit mode

  const JobSeekerAddPublishingFormScreen({
    super.key,
    this.publicationData,
  });

  @override
  State<JobSeekerAddPublishingFormScreen> createState() => _JobSeekerAddPublishingFormScreenState();
}

class _JobSeekerAddPublishingFormScreenState extends State<JobSeekerAddPublishingFormScreen> {
  final controller = getOrPut(() => PublicationsController());
  // final controller = Get.put(PublicationsController());
