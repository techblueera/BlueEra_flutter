...
class JobSeekerHobbiesFormScreen extends StatefulWidget {
  JobSeekerHobbiesFormScreen({super.key});

  @override
  State<JobSeekerHobbiesFormScreen> createState() => _JobSeekerHobbiesFormScreenState();
}

class _JobSeekerHobbiesFormScreenState extends State<JobSeekerHobbiesFormScreen> {
