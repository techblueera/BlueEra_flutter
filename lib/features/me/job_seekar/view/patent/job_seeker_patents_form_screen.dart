...
class JobSeekerPatentsFormScreen extends StatefulWidget {
  final bool isEdit;
  final String? experienceId;

  const JobSeekerPatentsFormScreen({Key? key, this.isEdit = false, this.experienceId})
      : super(key: key);

  @override
  State<JobSeekerPatentsFormScreen> createState() => _JobSeekerPatentsFormScreenState();
}

class _JobSeekerPatentsFormScreenState extends State<JobSeekerPatentsFormScreen> {
  ...
  final patentController = getOrPut(() => EntityController(isPatent: true));
