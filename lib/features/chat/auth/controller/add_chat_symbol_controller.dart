  ...
  Future<bool> createSymbol() async {
    ...
    if (itTextOrLinkPost() && linkTextSymbolController.text.trim().isEmpty) {
      if (selectedPostType.value == PostType.text) {
        commonSnackBar(message: "Please enter the text");
      } else {
        commonSnackBar(message: "Please enter the link");
      }
      return false;
    }
    if (itMediaPost() && imagesList.isEmpty) {
      commonSnackBar(message: "Please select an image or video");
      return false;
    }
