...
class AiSocketService {
  ...
  Future<void> connect() async {
    ...
    // GLOBAL LISTENERS
    socket!.onConnect((_) {
      print("AI Socket Connected________________ sdflklsklsdkcmsldkcmsldkcmsdlkcmsdlkcmsdlkc");
    });

    socket!.onDisconnect((_) {
      print("AI Socket Disconnected sdflklsklsdkcmsldkcmsldkcmsdlkcmsdlkcmsdlkc");
    });

    socket!.onConnectError((data) {
      print("️AI Socket Connect Error: $data sdflklsklsdkcmsldkcmsldkcmsdlkcmsdlkcmsdlkc");
    });

    socket!.onError((data) {
      print("AI Socket Error: $data sdflklsklsdkcmsldkcmsldkcmsdlkcmsdlkcmsdlkc");
    });
  }
