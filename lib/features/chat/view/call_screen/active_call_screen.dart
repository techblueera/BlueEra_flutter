...
//     return LayoutBuilder(
//       builder: (context, constraints) {
//         // Avatar scales with available space so it stays proportionate on
//         // small phones and doesn't overwhelm tablets.
//         final avatarRadius =
//             (constraints.maxWidth * 0.28).clamp(70.0, 110.0).toDouble();
//         return Stack(
//           fit: StackFit.expand,
//           children: [
//             // Solid dark background (WhatsApp call style)
//             Container(color: const Color(0xFF0B141A)),
//             // Large centered avatar (name/status live in the top bar now)
//             Center(
//               child: Column(
//                 mainAxisSize: MainAxisSize.min,
//                 children: [
//                   Obx(() => _buildCircleAvatar(
//                         name: controller.remoteUserName.value,
//                         image: controller.remoteUserImage.value,
//                         radius: avatarRadius,
//                       )),
...
//                                   Text(
//                                     '· ${controller.remoteStreams.length + 1}',
//                                     style: TextStyle(
//                                       color:
...
//                     );
//                   }
//                   // Keep layout symmetric when button is hidden.
...
//                 // 5 buttons: More | Camera/VideoSwitch | Speaker | Mute | End
//                 // Size adapts to pill width — clamped so it stays tap-friendly.
//                 final available =
//                     constraints.maxWidth - (horizontalPad * 2);
//                 final buttonSize =
//                     (available / 5 - 4).clamp(42.0, 56.0).toDouble();
//
//                 return Container(
...
//                       Obx(() {
//                         final cameraOn =
//                             currentIsVideo && controller.isCameraOn.value;
//                         return _buildPillButton(
//                           icon: cameraOn
//                               ? Icons.videocam_rounded
//                               : Icons.videocam_off_rounded,
//                           size: buttonSize,
//                           isActive: currentIsVideo &&
...
//                                   } else if (isConnected) {
//                                     // Tap to switch audio → video
//                                     controller.switchCallType();
//                                   }
//                                 },
//                         );
//                       }),
//                       Obx(() => _buildPillButton(
...
//     bool bold = false,
//   }) {
//     // Solid dark circles inside the pill (WhatsApp reference).
//     // Active state lightens the fill so speaker/camera-off stay readable.
