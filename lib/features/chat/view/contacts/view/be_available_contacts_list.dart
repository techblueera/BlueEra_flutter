            ...
            child: CustomBtn(
              ...
              onTap: _selectedUsers.isEmpty
                ...
                if(widget.tagPersonsSelection==true){
                  ...
                  // Resolved before the await: forwarding is a network call,
                  // and the two pops unwind this sheet and the picker behind
                  // it.
                  ...
                  if (value) {
                    // Not gated on `mounted` — this is a socket emit that
                    // refreshes the chat list, and it has to happen whether or
                    // not this sheet survived.
