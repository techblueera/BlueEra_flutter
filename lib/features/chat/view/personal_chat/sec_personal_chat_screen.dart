...
class SecNewPersonalChatScreen extends StatefulWidget {
  SecNewPersonalChatScreen(
  ...
  @override
  State<SecNewPersonalChatScreen> createState() => _SecNewPersonalChatScreenState();
}

class _SecNewPersonalChatScreenState extends State<SecNewPersonalChatScreen> {
