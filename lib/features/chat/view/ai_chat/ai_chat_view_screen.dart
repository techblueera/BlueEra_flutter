...
import 'package:BlueEra/features/chat/view/ai_chat/widgets/ai_chat_input_box.dart';
...
class AiChatViewScreen extends StatefulWidget {
  AiChatViewScreen(
  ...
  @override
  State<AiChatViewScreen> createState() => _AiChatViewScreenState();
}

class _AiChatViewScreenState extends State<AiChatViewScreen> {
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      (widget.type=="Admin")?SizedBox(): AiChatInputBox(
