  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Scaffold(
        ...
        body: Obx(() {
          if(chatViewController.askAiFor.value!=null){
            switch(chatViewController.askAiFor.value?.slugId){
              case PRODUCT:
                return _AskInventoryAiWidget();
              case FOOD:
                return SizedBox();
              case SERVICE:
                return SizedBox();
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return CommonServiceCard(
                                  ...
                                  onTap: () {
                                      ...
                                      switch(chatViewController.askAiFor.value?.slugId){
                                        case PRODUCT:
                                          chatViewController.getListOfInventoryAiMessages?.add(InventoryAskAiModel(
                                              reply: productInitialMessage,
                                              messageStatus: AppConstants.AiReply_Chat_Type,
