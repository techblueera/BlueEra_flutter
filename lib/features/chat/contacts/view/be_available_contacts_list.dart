      ...
      child: Scaffold(
        ...
        bottomNavigationBar: isGroupMode
          ...
          child: Container(
            ...
            child: CustomBtn(
              bgColor: _selectedUsers.isEmpty?theme.colorScheme.primary.withOpacity(0.5):theme.colorScheme.primary,
                ...
                if(widget.isFromAddMember==true){
                  ...
                  if(widget.sharedFiles!=null){
                    ...
                    chatViewController.generateUploadUrlsApi(
                      ...
                      isInitialMessage:( _selectedUsers.first.conversationId==null||_selectedUsers.first.conversationId=='null'||_selectedUsers.first.conversationId=='')?true:false,
                    ...
                    Map<String,dynamic> data = {
                      if( _selectedUsers.first.conversationId==null||_selectedUsers.first.conversationId=='null'||_selectedUsers.first.conversationId=='')
