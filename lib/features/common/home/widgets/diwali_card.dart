...
class DiwaliOfferCardScreen extends StatelessWidget {
  ...
  final int index;
  DiwaliOfferCardScreen({super.key, required this.cardKey, required this.ownProductData, required this.index});
      ...
      body: Center(
        child: RepaintBoundary(
          ...
          child: Stack(
            ...
            children: [
              Image.asset('assets/diwali_card/cardbg1.png'),
              Positioned(
                top: cardHeight * 0.12, // Proportional vertical position
                left: 20 * scaleFactor,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.white, width: 0.8 * scaleFactor),
                                  boxShadow: [
                                    BoxShadow(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Colors.white, width: 1.3 * scaleFactor),
                        boxShadow: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.whiteFade.withOpacity(0.30),
                    borderRadius: BorderRadius.circular(10 * scaleFactor),
                    border: Border.all(color: Colors.white.withOpacity(0.2), width: 0.8 * scaleFactor),
                    boxShadow: [
                      BoxShadow(
                        color: Colors.white.withOpacity(0.1),
                        blurRadius: 4 * scaleFactor,
