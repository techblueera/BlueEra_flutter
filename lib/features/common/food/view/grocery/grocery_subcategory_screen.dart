...
class _GrocerySubCategoryScreenState extends State<GrocerySubCategoryScreen> {
  ...
  void initState() {
    ...
    controller.fetchBoth(selectedGroceryData.tagId);
        ...
        itemBuilder: (context, index) {
          return Obx(()=> _categoryItem(
            ...
            onTap: () {
              ...
              /// api call
              controller.fetchBoth(controller.selectedGrocery.value);

              // controller.fetchChildrenOfGroceryCategory(key: controller.selectedGrocery.value);
              // controller.fetchGroceryCategories(key: controller.selectedGrocery.value);
    ...
    return Obx(()=> Padding(
      ...
      child: controller.isInitialLoading.value
        ...
        children: [
          ...
          // GRID
          controller.isGrocerySubCategoryLoading.value
              ? Center(
                child: Padding(
          ...
          : Expanded(
            child: GridView.builder(
              itemCount: controller.arrGroceryProducts.length,
