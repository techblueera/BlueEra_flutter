...
class FruitsVegPage extends StatefulWidget {
  const FruitsVegPage({super.key});

  @override
  State<FruitsVegPage> createState() => _FruitsVegPageState();
}
...
class _FruitsVegPageState extends State<FruitsVegPage> {
  ...
  List<String> leftIcons = [
    "assets/category/freshfruits.png",
    "assets/category/basicveg.png",
    "assets/category/premiumveg.png",
  ...
  Map<String, List<ProductModel>> categoryProducts = {
    "Fresh Fruits": [
      ProductModel(
          ...
          image: "assets/category/dal/guva.png",
          weight: "1 KG",
          price: 120,
          oldPrice: 160,
