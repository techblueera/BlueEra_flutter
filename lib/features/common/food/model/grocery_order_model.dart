...
List<GroceryOrdersModel> groceryOrdersModelFromList(List<dynamic> data) =>
    List<GroceryOrdersModel>.from(
        data.map((x) => GroceryOrdersModel.fromJson(x)));

String groceryOrdersModelToJson(List<GroceryOrdersModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GroceryOrdersModel {
  String? orderId;
  ...
  factory GroceryOrdersModel.fromJson(Map<String, dynamic> json) =>
      GroceryOrdersModel(
