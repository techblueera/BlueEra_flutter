...
//   const PersonalInformationRidingScreen({super.key, required this.screeName});
//
//   final String screeName;
//
//   @override
//   State<PersonalInformationRidingScreen> createState() =>
//       _PersonalInformationRidingScreenState();
// }
//
// class _PersonalInformationRidingScreenState
...
//         viewProfileController.personalProfileDetails.value.user?.contactNo ??
//             '';
//     controller.selectedGender.value = GenderTypeExtension.fromString(
...
//             ?.toInt() ??
//         0;
//     controller.selectedMonth?.value = viewProfileController
//             .personalProfileDetails.value.user?.dateOfBirth?.month
//             ?.toInt() ??
//         0;
//     controller.selectedYear?.value = viewProfileController
...
//                         onDayChanged: (value) {
//                           controller.selectedDay?.value = value ?? 0;
//                         },
//                         onMonthChanged: (value) {
//                           controller.selectedMonth?.value = value ?? 0;
//                         },
//                         onYearChanged: (value) {
//                           controller.selectedYear?.value = value ?? 0;
//                         },
//                       ),
//                       SizedBox(height: SizeConfig.paddingM),
//                       Row(
...
//                             onTap: () async {
//                               final result =
//                                   await CommonMobileOtpDialog().show(context);
//
//                               if (result == true) {
...
//                             ),
//                             child:
//                                 CustomText("+91", fontSize: SizeConfig.large),
//                           ),
...
//                         isLoading:
//                             controller.isPersonalInformationLoading.value,
//                       ),
//                     ],
//                   ),
//                 ),
