...
class AddUpdateProductScreen extends StatefulWidget {
  ...
  AddUpdateProductScreen(
      {super.key, required this.channelId, required this.productData});
...
class _AddUpdateProductScreenState extends State<AddUpdateProductScreen> {
  ...
  initState() {
    ...
    if (productData != null) {
      ...
      addUpdateProductController.productDescriptionController.text =
          productData?.description ?? '';
      addUpdateProductController.productPriceController.text =
          productData?.price ?? '';
        ...
        body: SafeArea(
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: AppColors.whiteFE),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  /// Product Image
                  _buildTitle(title: AppStrings.productImage),
                  Obx(() => _buildImagePickerWidget(
                        ...
                        onSelect: (context) {
                          addUpdateProductController.selectImage(
                              context); // your method to pick image
                        },
                      )),
                  ...
                  CommonTextField(
                    textEditController:
                        addUpdateProductController.titleController,
                    maxLength: 50,
                    maxLine: 1,
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return AppStrings.pleaseEnterProductTitle.tr;
                      }
                      return null;
                    },
                  ...
                  CommonTextField(
                    textEditController:
                        addUpdateProductController.productDescriptionController,
                    maxLength: 200,
                    inputLength: 200,
                    maxLine: 4,
                    keyBoardType: TextInputType.text,
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        ...
                        return AppStrings.productDescriptionTooShort.tr;
                      }
                      return null;
                    },
                    autovalidateMode: AutovalidateMode.onUserInteraction,
                  ...
                  CommonTextField(
                    textEditController:
                        addUpdateProductController.productPriceController,
                    maxLine: 1,
                    keyBoardType: TextInputType.number,
                    title: AppStrings.productPrice,
                    hintText: AppStrings.enter_product_price,
                    isValidate: true,
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  HttpsTextField(
                    ...
                    hintText: AppStrings.addLinkPlaceholder,
                    isUrlValidate: true,
                  ),
                      ...
                      onTap: () {
                        if (productData != null) {
                          addUpdateProductController
                              .updateChannelProduct(productData?.sId ?? '');
                        } else {
                          addUpdateProductController
                              .addChannelProduct(widget.channelId);
                        }
                      },
                      radius: 10,
                      title: (productData != null)
  ...
  Widget _buildImagePickerWidget(
    ...
    return Padding(
      ...
      child: (imagePath?.isNotEmpty ?? false)
          ? Container(
              padding: EdgeInsets.symmetric(
                  horizontal: SizeConfig.size10, vertical: SizeConfig.size12),
