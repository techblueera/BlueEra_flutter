...
class StoreFoodServiceCard extends StatelessWidget {
  ...
  const StoreFoodServiceCard(
      {Key? key, this.foodDetailsData, required this.isShowInGrid})
      : super(key: key);
    ...
    return InkWell(
      onTap: () {
        Get.to(() => FoodDetailsViewScreen(
              productPriceFormat: (foodDetailsData?.priceType == "single")
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              (foodDetailsData?.vegType == null)
                                  ...
                                  : Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: controller.getFoodTypeColor(
                                            foodDetailsData?.vegType),
                        ...
                        StoreKmAwayTextWidget(
                          lat: foodDetailsData?.business?.businessLocation?.lat
                                  ?.toDouble() ??
                              0.0,
                          long: foodDetailsData?.business?.businessLocation?.lon
                                  ?.toDouble() ??
                              0.0,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FittedBox(
                            ...
                            child: (foodDetailsData?.priceType == "single")
                                ? CustomText(
                                    "${AppStrings.price.tr} : ₹ ${foodDetailsData?.singlePrice ?? "0"}",
                                    fontSize: SizeConfig.small,
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 1,
                                    color: AppColors.primaryColor,
                          ...
                          StoreKmAwayTextWidget(
                            lat: foodDetailsData
                                    ?.business?.businessLocation?.lat
                                    ?.toDouble() ??
                                0.0,
                            long: foodDetailsData
                                    ?.business?.businessLocation?.lon
                                    ?.toDouble() ??
                                0.0,
                            isUnderlineShow: false,
                            isPadding: 4.0,
