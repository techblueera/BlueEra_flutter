...
class DiscoverNewScreen extends StatefulWidget {
  final bool isHeaderVisible;
  final Function(bool isVisible)? onHeaderVisibilityChanged;

  const DiscoverNewScreen(
      {super.key,
        required this.isHeaderVisible,
        this.onHeaderVisibilityChanged});

  @override
  State<DiscoverNewScreen> createState() => _DiscoverNewScreenState();
}

class _DiscoverNewScreenState extends State<DiscoverNewScreen> {
  ...
  List<({Widget widget, Set<int> tabs})> get _sections => [
        ...
        (widget: HotelStayServiceCard(isShowInGrid: true), tabs: {1}),
        (widget: FinancialSectors(isShowInGrid: true), tabs: {4}),
