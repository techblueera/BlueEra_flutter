...
/// **Book Home Services — entry (v2).**
///
/// Location-first landing for the self-employed discover flow (design:
...
class SelfProfessionDiscoverEntryScreen extends StatefulWidget {
  final List<ProfessionTypeData> selfEmployedCategories;

  const SelfProfessionDiscoverEntryScreen({
    super.key,
    required this.selfEmployedCategories,
  });

  @override
  State<SelfProfessionDiscoverEntryScreen> createState() =>
      _SelfProfessionDiscoverEntryScreenState();
}
...
class _SelfProfessionDiscoverEntryScreenState
  ...
  LatLng get _mapTarget => (_lat != null && _lng != null && !(_lat == 0 && _lng == 0))
      ? LatLng(_lat!, _lng!)
      : _fallbackCenter;
  ...
  void _onCategoryTap(ProfessionTypeData c) {
    ...
    Get.to(() => SelfProfessionDiscoverScreenV2(
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Header: back + "Book Home Services" pill.
          Positioned(
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: CustomText(
                      AppStrings.bookHomeServices.tr,
                      fontSize: 17,
  ...
  Widget _categoryGrid() {
    final cats = widget.selfEmployedCategories;
  ...
  Widget _categoryTile(ProfessionTypeData c, double width) {
    ...
    final name = rawName.toLowerCase().startsWith('home ')
