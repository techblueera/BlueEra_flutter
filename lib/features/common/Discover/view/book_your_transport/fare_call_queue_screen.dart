...
class _FareCallQueueScreenState extends State<FareCallQueueScreen>
  ...
  List<BlueMapMarker> get _markers {
    ...
    return [
      ...
      // The drop only becomes relevant once the ride is under way — before
      // that the map is about the rider reaching the customer.
  ...
  Future<void> _syncRideStartedMap() async {
    ...
    // Markers follow from `_rideStartedMapSynced` — the drop pin appears and
    // the route is re-fetched for the pickup→drop leg below.
