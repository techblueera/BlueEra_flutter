...
class RentalCardWidget extends StatefulWidget {
  const RentalCardWidget({super.key});

  @override
  State<RentalCardWidget> createState() => _RentalCardWidgetState();
}

class _RentalCardWidgetState extends State<RentalCardWidget> {
  bool _showAll = false;
