...
class _JobFilterDialogState extends State<JobFilterDialog> {
  ...
  final Map<String, List<String>> filterValues = {
    JobFilteredCategory.postedIn.label: [
      'All',
      'Last 24 Hours',
      'Last 3 Days',
      'Last 7 Days'
    ...
    JobFilteredCategory.jobType.label: [
      'Full Time',
      'Part Time',
      'Internship',
      'Freelance'
    ],
    JobFilteredCategory.workShift.label: [
      'Day Shift',
      'Night Shift',
      'Rotational Shift'
    ],
  ...
  List<String> get activeTags =>
      selectedFilters.values.expand((e) => e).toList();
                            ...
                            child: Builder(
                              builder: (_) {
                                ...
                                if (selectedCategory ==
                                    JobFilteredCategory.postedIn.label) {
                                  final selected =
                                      selectedFilters[selectedCategory]?.first;
                                  return Column(
                                ...
                                // Salary TextField
                                if (selectedCategory ==
                                    JobFilteredCategory.salary.label) {
                                  return Column(
                                    crossAxisAlignment:
