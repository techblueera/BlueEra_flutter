...
class MessagePostPreviewScreen extends StatefulWidget {
  final String? imagePath;
  final PostVia? postVia;

  MessagePostPreviewScreen({Key? key, required this.imagePath, this.postVia})
      : super(key: key);

  @override
  State<MessagePostPreviewScreen> createState() =>
      _MessagePostPreviewScreenState();
}

class _MessagePostPreviewScreenState extends State<MessagePostPreviewScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      msgPostController.isMsgPostEdit
                          ? NetWorkOcToAssets(
                              imgUrl: msgPostController.uploadMsgPostUrl.value)
                          : Image.file(File(widget.imagePath ?? "")),

                      Padding(
                        padding: EdgeInsets.only(
                            top: SizeConfig.size15, bottom: SizeConfig.size15),
                        child: CustomText(
                      ...
                      if (msgPostController
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              top: SizeConfig.size10, bottom: SizeConfig.size15),
                          child: CustomText(
                            ...
                            child: PositiveCustomBtn(
                              onTap: () async {
                                try {
                                  ...
                                  if (msgPostController.isMsgPostEdit) {
                                    reqData = {
                                      ...
                                      ApiKeys.sub_title: msgPostController
                                          ...
                                          : "",
                                      ApiKeys.nature_of_post: msgPostController
                                      ...
                                      ApiKeys.reference_link: msgPostController
                                      ...
                                      ApiKeys.tagged_users:
                                          tagUserIds.isNotEmpty ? tagUserIds : ""
                                    };
                                  } else {
                                    ...
                                    reqData = {
                                      ...
                                      if (msgPostController.postTextDataController
                                          .value.text.isNotEmpty)
                                        ApiKeys.message: msgPostController
                                            .postTextDataController.value.text,
                                      if (msgPostController.descriptionMessage
                                          .value.text.isNotEmpty)
                                        ApiKeys.sub_title: msgPostController
                                            .descriptionMessage.value.text,
                                      if (msgPostController.natureOfPostController
                                          .value.text.isNotEmpty)
                                        ApiKeys.nature_of_post: msgPostController
                                            .natureOfPostController.value.text,
                                      if (widget.imagePath?.isNotEmpty ?? false)
                                  ...
                                  await msgPostController.addMsgPostController(
                                    bodyReq: reqData,
                                  );
