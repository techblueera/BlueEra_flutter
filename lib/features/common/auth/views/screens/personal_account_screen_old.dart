...
//   SelfEmploymentType? _selectedSelfEmployment;
//   ArtistCategory? _selectedArtistCategory;
//
...
//                 ),
//
//                 if ((_selectedProfession == ProfessionType.SELF_EMPLOYED)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//
...
//                     height: SizeConfig.size10,
//                   ),
//                   CommonDropdownDialog<SelfEmploymentType>(
//                     items: SelfEmploymentType.values,
//                     selectedValue: _selectedSelfEmployment,
...
//                 ],
//
//                 if ((_selectedProfession == ProfessionType.SKILLED_WORKER)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//                   CommonTextField(
...
//                 ],
//
//                 if ((_selectedProfession == ProfessionType.REG_UNION)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//                   CommonTextField(
...
//                   ),
//                 ],
//                 if ((_selectedProfession == ProfessionType.INDUSTRIALIST)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//                   CommonTextField(
...
//                 ],
//
//                 if ((_selectedProfession == ProfessionType.HOMEMAKER)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//                   CommonTextField(
...
//                   ),
//                 ],
//                 if ((_selectedProfession == ProfessionType.STUDENT)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//                   CommonTextField(
...
//                 ],
//
//                 if ((_selectedProfession == ProfessionType.ARTIST)) ...[
//                   SizedBox(
//                     height: SizeConfig.size20,
//                   ),
//
...
//                     // },
//                   ),
//                   if (_selectedArtistCategory != null) ...[
//                     SizedBox(
//                       height: SizeConfig.size15,
//                     ),
//                     CommonTextField(
...
//                   height: SizeConfig.size20,
//                 ),
//                 if (_selectedProfession == ProfessionType.OTHERS) ...[
//                   CommonTextField(
//                     isValidate: false,
//
...
//                   ),
//                 ],
//                 if (_selectedProfession == ProfessionType.POLITICIAN) ...[
...
//                 ],
//
//                 if ((_selectedProfession == ProfessionType.GOVTPSU)) ...[
//                   CommonTextField(
//                     isValidate: false,
//
...
//                   SizedBox(height: SizeConfig.size18),
//                 ],
//                 if (_selectedProfession == ProfessionType.PRIVATE_JOB) ...[
//                   CommonTextField(
//                     isValidate: false,
//
...
//
//                 if ((_selectedProfession != ProfessionType.SELF_EMPLOYED) &&
//                     (_selectedProfession != ProfessionType.SKILLED_WORKER) &&
//                     (_selectedProfession != ProfessionType.ARTIST) &&
//                     (_selectedProfession != ProfessionType.CONTENT_CREATOR) &&
//                     (_selectedProfession != ProfessionType.HOMEMAKER) &&
//                     (_selectedProfession !=
//                         ProfessionType.SENIOR_CITIZEN_RETIRED) &&
//                     (_selectedProfession != ProfessionType.FARMER) &&
//                     (_selectedProfession != ProfessionType.STUDENT) &&
//                     (_selectedProfession != ProfessionType.OTHERS)) ...[
//                   CommonTextField(
//                     textEditController: _designationTextController,
//                     inputLength: 24,
//                     keyBoardType: TextInputType.text,
...
//                 ],
//                 if ((_selectedProfession == ProfessionType.POLITICIAN) ||
//                     (_selectedProfession == ProfessionType.GOVTPSU) ||
//                     (_selectedProfession == ProfessionType.CONTENT_CREATOR) ||
//                     (_selectedProfession == ProfessionType.REG_UNION) ||
//                     (_selectedProfession == ProfessionType.MEDIA) ||
//                     (_selectedProfession == ProfessionType.INDUSTRIALIST) ||
//                     (_selectedProfession == ProfessionType.ARTIST)) ...[
//                   Obx(() {
//                     return Row(
...
//                             onTap: () {
//                               userNameController.text=authController.userNameList[i];
//                               authController.select(i);
//                             },
//                             child: Container(
//                               padding:  EdgeInsets.symmetric(horizontal: SizeConfig.size10, vertical: 5),
//                               decoration: BoxDecoration(
...
//                 ],
//
//                 if ((_selectedProfession?.name !=
//                     ProfessionType.GOVTPSU.name) &&
//                     (_selectedProfession?.name !=
//                         ProfessionType.POLITICIAN.name) &&
//                     (_selectedProfession?.name != ProfessionType.MEDIA.name) &&
//                     (_selectedProfession?.name !=
//                         ProfessionType.REG_UNION.name) &&
//                     (_selectedProfession?.name !=
//                         ProfessionType.INDUSTRIALIST.name)) ...[
//                   ..._referralCodeEnable
//                       ? [
//                     CommonTextField(
//                       isValidate: false,
...
//       }
//       if (_selectedProfession == ProfessionType.ARTIST) {
//         if (_selectedArtistCategory?.name.isEmpty ?? true) {
...
//       String? designation;
//       if ((_selectedProfession == ProfessionType.SELF_EMPLOYED)) {
//         designation = _selectedSelfEmployment?.name ?? "";
//       } else {
...
//
//         ///CONDITION....
//         ApiKeys.profession: _selectedProfession?.name,
...
//         if (_selectedProfession == ProfessionType.CONTENT_CREATOR)
//           ApiKeys.specilization: _contentCraterTextController.text,
//
//         ///USER NAME
//         if ((_selectedProfession == ProfessionType.CONTENT_CREATOR) ||
//             (_selectedProfession == ProfessionType.POLITICIAN) ||
//             (_selectedProfession == ProfessionType.REG_UNION) ||
//             (_selectedProfession == ProfessionType.INDUSTRIALIST) ||
//             (_selectedProfession == ProfessionType.ARTIST) ||
//             (_selectedProfession == ProfessionType.MEDIA) ||
...
//             ApiKeys.artName: _selectedArtistCategory?.name,
...
//           }),
//
//         if (_selectedProfession == ProfessionType.SENIOR_CITIZEN_RETIRED)
//           ApiKeys.art: jsonEncode({
