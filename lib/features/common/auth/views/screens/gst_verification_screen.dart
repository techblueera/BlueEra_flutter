...
class GstNumberScreenForProfile extends StatefulWidget {
  @override
  State<GstNumberScreenForProfile> createState() => _GstNumberScreenForProfileState();
}

class _GstNumberScreenForProfileState extends State<GstNumberScreenForProfile> {
  final _formKey = GlobalKey<FormState>();
  final authController = Get.find<AuthController>();
