...
class BusinessLocation {
  ...
  /// The fields are `dynamic`, so the assignments themselves were always safe;
  /// only the shape check was missing. `dynamic` parameter so a non-map
  /// `business_location` returns empty instead of failing at the parameter.
