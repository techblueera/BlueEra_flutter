...
class ServiceCard extends StatelessWidget {
  ...
  const ServiceCard({super.key,  required this.isPlaceService,required this.placeList});
        ...
        showModalBottomSheet(
          ...
          builder: (_) => CommonDraggableBottomSheet(
            builder: (scrollController) =>
                OtherProfileDetailsBottomSheet(scrollController: scrollController, isUserProfile: true, isPlaceService: isPlaceService, placeId: placeList.id,),
          ),
        );
      },
      child: Container(
            ...
            ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                width: MediaQuery.of(context).size.width,
                              fit: BoxFit.fill,
                              imageUrl: "${placeList.photos[0].toString()}",
