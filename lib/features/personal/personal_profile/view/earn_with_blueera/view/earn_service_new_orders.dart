...
class EarnServiceNewOrders extends StatefulWidget {
  const EarnServiceNewOrders({super.key});

  @override
  State<EarnServiceNewOrders> createState() => _EarnServiceNewOrdersState();
}

class _EarnServiceNewOrdersState extends State<EarnServiceNewOrders> {
