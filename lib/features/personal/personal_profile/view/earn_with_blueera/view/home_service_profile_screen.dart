...
class HomeServiceProfileScreen extends StatefulWidget {
  const HomeServiceProfileScreen({super.key});

  @override
  State<HomeServiceProfileScreen> createState() =>
      _HomeServiceProfileScreenState();
}

class _HomeServiceProfileScreenState extends State<HomeServiceProfileScreen> {
  ...
  Future<void> _pickLogo() async {
    final path = await CommonImageUploadTile.pickImage(
      context: context,
      title: AppStrings.yourServiceLogo.tr,
    );
    if (path != null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonBackAppBar(title: AppStrings.homeServices.tr),
            ...
            child: Column(
              ...
              children: [
                ...
                CommonTextField(
                  ...
                  hintText: AppStrings.egMamtaBeautyParlour.tr,
                  isValidate: true,
                ),
                ...
                _buildToggleRow(
                  label: AppStrings.doYouProvideOnDoorStep.tr,
                  value: _doorStepService,
                  onChanged: (v) => setState(() => _doorStepService = v),
                ),
                SizedBox(height: SizeConfig.size20),
