...
class EarnServiceSelectionScreen extends StatefulWidget {
  const EarnServiceSelectionScreen({super.key});

  @override
  State<EarnServiceSelectionScreen> createState() =>
      _EarnServiceSelectionScreenState();
}

class _EarnServiceSelectionScreenState
    extends State<EarnServiceSelectionScreen> {
