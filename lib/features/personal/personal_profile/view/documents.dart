...
class AddYourDocumentScreen extends StatefulWidget {
  const AddYourDocumentScreen({super.key, this.documentVia});

  final String? documentVia;

  @override
  State<AddYourDocumentScreen> createState() => _AddYourDocumentScreenState();
}

class _AddYourDocumentScreenState extends State<AddYourDocumentScreen> {
