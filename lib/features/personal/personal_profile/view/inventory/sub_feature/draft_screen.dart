...
import 'package:BlueEra/features/personal/personal_profile/view/inventory/sub_feature/draft_controller.dart';
...
void initState() {
  super.initState();
  controller = Get.isRegistered<DraftController>()
  ...
  Widget _buildProductCard(ProductModel product, DraftController controller) {
    return Container(
