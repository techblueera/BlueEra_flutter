...
//   final Map<String, RxList<String>>? dynamicAttributes;  /// we will send all the dynamic attribute available
//
//   ProductPreviewArgs({
//     this.productId,
//     this.media,
...
//
//   const ProductPreviewScreen({super.key, required this.productPreviewArgs});
//
//   @override
...
//   @override
//   void initState() {
//     controller.productId = widget.productPreviewArgs?.productId;
...
//      if(args.listedProducts?.isNotEmpty??false) controller.listedProducts.value = args.listedProducts!;
//      if(args.selectedColors?.isNotEmpty??false) controller.selectedColors.value = args.selectedColors!;
//      if(args.dynamicAttributes?.isNotEmpty??false) controller.dynamicAttributes.value = args.dynamicAttributes!;
//   }
//
//   @override
//   void dispose() {
...
//     return PopScope(
//       canPop: (widget.productPreviewArgs!=null) ? true : false,
...
//             controller.allProductsImages.value = widget.productPreviewArgs?.media??[];
...
//             controller.allProductsImages.value = product.image;
