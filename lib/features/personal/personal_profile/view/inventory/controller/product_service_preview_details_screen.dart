...
class ProductPreviewDetailsScreen extends StatelessWidget {
  final AiProductResData? data = Get.find<ProductBusinessProfileFullController>().aiProductRes?.value.data;
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: PositiveCustomBtn(onTap: () async {
            await Get.find<ProductBusinessProfileFullController>().createProductProfileController();
          ...
          children: [
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                final service = data!.products![index];
                return Card(
                  elevation: 0,
