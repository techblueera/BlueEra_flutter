...
//
//     final receivedEnquiryList = receivedEnquiryListFromJson(jsonString);

import 'dart:convert';

ReceivedEnquiryList receivedEnquiryListFromJson(String str) => ReceivedEnquiryList.fromJson(json.decode(str));

String receivedEnquiryListToJson(ReceivedEnquiryList data) => json.encode(data.toJson());

class ReceivedEnquiryList {
    bool success;
    List<ReceivedEnquiryData> data;
    ...
    factory ReceivedEnquiryList.fromJson(Map<String, dynamic> json) => ReceivedEnquiryList(
        success: json["success"],
        data: List<ReceivedEnquiryData>.from(json["data"].map((x) => ReceivedEnquiryData.fromJson(x))),
    );
...
class ReceivedEnquiryData {
    ...
    factory ReceivedEnquiryData.fromJson(Map<String, dynamic> json) => ReceivedEnquiryData(
        tags: List<dynamic>.from(json["tags"].map((x) => x)),
        keywords: List<String>.from(json["keywords"].map((x) => x)),
        categories: List<String>.from(json["categories"].map((x) => x)),
        taggedUsers: List<dynamic>.from(json["tagged_users"].map((x) => x)),
        taggedChannelProducts: List<dynamic>.from(json["tagged_channel_products"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "tagged_channel_products": List<dynamic>.from(taggedChannelProducts.map((x) => x)),
