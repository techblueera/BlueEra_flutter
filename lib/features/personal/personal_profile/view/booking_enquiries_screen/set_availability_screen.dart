...
class _SetAvailabilityScreenState extends State<SetAvailabilityScreen> {
    ...
    if (_overlayEntry == null) {
      _overlayEntry = OverlayEntry(
        builder: (context) => Positioned(
          left: offset.dx, top: offset.dy + size.height + 10, width: size.width,
          child: CompositedTransformFollower(
            link: _layerLink, showWhenUnlinked: false,
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(child: CustomText(controller.errorMessage.value, fontSize: SizeConfig.medium, color: Colors.red)),
                        ],
                      ),
                    );
                  } else if (controller.predictions.isEmpty && controller.locationController.text.isNotEmpty) {
                    return Padding(
                      padding: const EdgeInsets.all(16),
                      child: Row(
                        children: [
                          Icon(Icons.search_off, color: AppColors.secondaryTextColor, size: 18),
                          const SizedBox(width: 8),
                          CustomText("No results found", fontSize: SizeConfig.medium, color: AppColors.secondaryTextColor),
                        ],
                      ),
                    );
                    ...
                    return Scrollbar(
                      ...
                      child: SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          separatorBuilder: (_, __) => Divider(height: 1, color: AppColors.greyE5),
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              leading: Container(
                                ...
                                child: Icon(Icons.location_on_outlined, color: AppColors.primaryColor, size: 16),
                              ),
                              title: CustomText(prediction.description ?? '', fontSize: SizeConfig.medium, fontWeight: FontWeight.w500, color: AppColors.mainTextColor),
                              onTap: () {
                ...
                children: [
                  ...
                  _buildSectionCard(
                    ...
                    child: CommonTextField(
                      ...
                      hintText: "E.g. Please bring the required documents, call before arriving...",
                      maxLength: 300,
                      maxLine: 4,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomText(subtitle, fontSize: SizeConfig.small, fontWeight: FontWeight.w400, color: AppColors.secondaryTextColor),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildBookingTypeSelector() {
    final types = [
      (label: AppStrings.online,  type: BookingType.online,  icon: Icons.videocam_outlined),
      (label: AppStrings.offline, type: BookingType.offline, icon: Icons.handshake_outlined),
      (label: AppStrings.both,    type: BookingType.both,    icon: Icons.swap_horiz_rounded),
    ];
    ...
    return Obx(() => Row(
      children: types.map((item) {
        ...
        return Expanded(
          child: Padding(
            padding: EdgeInsets.only(right: item.type != BookingType.both ? SizeConfig.size8 : 0),
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Column(
                  children: [
                    Icon(item.icon, color: isSelected ? Colors.white : AppColors.secondaryTextColor, size: 20),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomText(
                          ...
                          fontWeight: controller.currentAddress.value.isNotEmpty
                              ? FontWeight.w500
                              : FontWeight.w400,
                        ),
                      ),
                      if (controller.currentAddress.value.isEmpty)
                        Icon(Icons.refresh_rounded, color: AppColors.primaryColor, size: 18),
                    ],
                  ),
                ),
              ),
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              ...
              children: [
                Icon(icon, size: 14, color: isSelected ? Colors.white : AppColors.secondaryTextColor),
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: CustomText('to', fontSize: SizeConfig.small, color: AppColors.secondaryTextColor),
            ),
            SizedBox(width: SizeConfig.size12),
            Expanded(
              child: Column(
