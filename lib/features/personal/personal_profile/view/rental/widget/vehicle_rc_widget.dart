...
class VehicleRcWidget extends StatelessWidget {
  VehicleRcWidget({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            CustomBtn(
              ...
              onTap: () {
                if (controller.rcFrontImage.value == null) {
                  commonSnackBar(message: AppStrings.pleaseSelectRcFrontImage.tr);
                  return;
                }
                if (controller.rcBackImage.value == null) {
                  commonSnackBar(message: AppStrings.pleaseSelectRcBackImage.tr);
                  return;
                }

                controller.uploadVehicleDocImagesApi(
                  frontImage: controller.rcFrontImage.value!,
                  backImage: controller.rcBackImage.value!,
                  sectionId: VehicleRentalServiceController.rc
               );
              },
              radius: 10.0,
