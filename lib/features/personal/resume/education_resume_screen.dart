...
class _EducationResumeScreenState extends State<EducationResumeScreen> {
                  ...
                  CommonCardWidget(
                    ...
                    children: [
                      ...
                      CommonDropdown<EducationType>(
                        ...
                        validator: (value) {
                          if (value == null) {
                            return AppStrings.selectYourEducation.tr;
                          }
                          return null;
                        },
                      )
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CommonDropdown<String>(
                          ...
                          validator: (value) {
                            if (value == null) {
                              return AppStrings.pleaseSelectAGradingSystem;
                            }
                            return null;
                          },
                        ),
                        ...
                        if (selectedGradingSystem != null)
                          Padding(
                            ...
                            child: CommonTextField(
                              ...
                              title: "${AppStrings.enterGrading.tr} ${selectedGradingSystem}",
                              titleColor: AppColors.black1A,
                              fontSize: SizeConfig.small,
                              fontWeight: FontWeight.w400,
  ...
  void validateForm() {
    ...
    final isSelectedGradingSystemEmpty =
        selectedGradingSystem?.isNotEmpty ?? false;
