...
class AddNgoScreen extends StatefulWidget {
  final bool isEdit;
  final String? experienceId;
  const AddNgoScreen({Key? key, this.isEdit = false, this.experienceId})
      : super(key: key);

  @override
  State<AddNgoScreen> createState() => _AddNgoScreenState();
}

class _AddNgoScreenState extends State<AddNgoScreen> {
                              ...
                              onTap: validate
                                  ? () async {
                                      final params = {
                                        ...
                                        'certifiedDate[date]': _selectedDay,
                                        'certifiedDate[month]': _selectedMonth,
                                        'certifiedDate[year]': _selectedYear,
                                      };
                                      if (widget.isEdit &&
