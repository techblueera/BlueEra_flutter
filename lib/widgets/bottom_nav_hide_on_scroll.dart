...
/// Pass-through wrapper. Used to drive
/// [BottomBarController.isBottomNavVisible] from scroll deltas, but the
/// new floating glassmorphic nav bar is meant to stay visible at all
/// times — so this widget no longer hides the bar. Kept as a thin
/// pass-through so existing call sites across the app don't have to
/// change to remove the wrapper.
class BottomNavHideOnScroll extends StatelessWidget {
