...
class CommonCardWidget extends StatelessWidget {
  ...
  const CommonCardWidget({super.key, required this.child, this.padding,  this.borderColorColor, this.borderRadius, this.shadowColor, this.cardMargin, this.bgColor});
